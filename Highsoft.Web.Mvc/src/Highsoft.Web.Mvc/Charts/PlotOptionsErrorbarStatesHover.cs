...
// Type: Highsoft.Web.Mvc.Charts.PlotOptionsErrorbarStatesHover
...
namespace Highsoft.Web.Mvc.Charts
{
  public class PlotOptionsErrorbarStatesHover : BaseObject
  {
    ...
    public PlotOptionsErrorbarStatesHover()
    {
      ...
      this.Halo = this.Halo_DefaultValue = new PlotOptionsErrorbarStatesHoverHalo();
      ...
      this.Marker = this.Marker_DefaultValue = new PlotOptionsErrorbarStatesHoverMarker();
    }
