// Type: Highsoft.Web.Mvc.Charts.ArearangeSeriesDataLabels
...
namespace Highsoft.Web.Mvc.Charts
{
    public class ArearangeSeriesDataLabels : BaseObject
    {
        ...
        {
            this.Align = this.Align_DefaultValue = ArearangeSeriesDataLabelsAlign.Center;
            ...
            this.Overflow = this.Overflow_DefaultValue = ArearangeSeriesDataLabelsOverflow.Justify;
            ...
            this.VerticalAlign = this.VerticalAlign_DefaultValue = ArearangeSeriesDataLabelsVerticalAlign.Null;
            nullable2 = new double?(0.0);
        ...
        internal override Hashtable ToHashtable()
        {
            ...
            if (this.Formatter != this.Formatter_DefaultValue)
            {
                ...
                Highcharts.AddFunction("ArearangeSeriesDataLabelsFormatter.formatter", this.Formatter);
            }
