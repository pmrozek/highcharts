// Type: Highsoft.Web.Mvc.Charts.PlotOptionsHeatmapDataLabels
...
namespace Highsoft.Web.Mvc.Charts
{
    public class PlotOptionsHeatmapDataLabels : BaseObject
    {
        ...
        {
            this.Align = this.Align_DefaultValue = PlotOptionsHeatmapDataLabelsAlign.Center;
            ...
            this.Overflow = this.Overflow_DefaultValue = PlotOptionsHeatmapDataLabelsOverflow.Justify;
            ...
            this.VerticalAlign = this.VerticalAlign_DefaultValue = PlotOptionsHeatmapDataLabelsVerticalAlign.Null;
            nullable2 = new double?(0.0);
