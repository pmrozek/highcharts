// Type: Highsoft.Web.Mvc.Charts.PlotOptionsTreemapDataLabels
...
namespace Highsoft.Web.Mvc.Charts
{
    public class PlotOptionsTreemapDataLabels : BaseObject
    {
        ...
        {
            this.Align = this.Align_DefaultValue = PlotOptionsTreemapDataLabelsAlign.Center;
            ...
            this.Overflow = this.Overflow_DefaultValue = PlotOptionsTreemapDataLabelsOverflow.Justify;
            ...
            this.VerticalAlign = this.VerticalAlign_DefaultValue = "middle";
            nullable2 = new double?(0.0);
