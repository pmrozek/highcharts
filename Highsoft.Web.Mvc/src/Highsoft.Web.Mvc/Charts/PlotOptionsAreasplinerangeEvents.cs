// Type: Highsoft.Web.Mvc.Charts.PlotOptionsAreasplinerangeEvents
    ...
    public class PlotOptionsAreasplinerangeEvents : BaseObject
    {
        ...
        internal override Hashtable ToHashtable()
        {
            ...
            if (this.CheckboxClick != this.CheckboxClick_DefaultValue)
            {
                ...
                Highcharts.AddFunction("PlotOptionsAreasplinerangeEventsCheckboxClick.checkboxClick",
                    this.CheckboxClick);
            }
            ...
            if (this.LegendItemClick != this.LegendItemClick_DefaultValue)
            {
                ...
                Highcharts.AddFunction("PlotOptionsAreasplinerangeEventsLegendItemClick.legendItemClick",
