// Type: Highsoft.Web.Mvc.Charts.WaterfallSeriesDataLabels
...
namespace Highsoft.Web.Mvc.Charts
{
    public class WaterfallSeriesDataLabels : BaseObject
    {
        ...
        {
            this.Align = this.Align_DefaultValue = WaterfallSeriesDataLabelsAlign.Center;
            ...
            this.Overflow = this.Overflow_DefaultValue = WaterfallSeriesDataLabelsOverflow.Justify;
            ...
            this.VerticalAlign = this.VerticalAlign_DefaultValue = WaterfallSeriesDataLabelsVerticalAlign.Null;
            nullable2 = new double?(0.0);
