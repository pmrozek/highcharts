...
// Type: Highsoft.Web.Mvc.Charts.PlotOptionsAreaStatesHover
...
namespace Highsoft.Web.Mvc.Charts
{
  public class PlotOptionsAreaStatesHover : BaseObject
  {
    ...
    public PlotOptionsAreaStatesHover()
    {
      ...
      this.Halo = this.Halo_DefaultValue = new PlotOptionsAreaStatesHoverHalo();
      ...
      this.Marker = this.Marker_DefaultValue = new PlotOptionsAreaStatesHoverMarker();
    }
