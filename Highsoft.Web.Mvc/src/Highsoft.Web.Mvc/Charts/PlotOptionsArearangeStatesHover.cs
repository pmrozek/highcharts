...
// Type: Highsoft.Web.Mvc.Charts.PlotOptionsArearangeStatesHover
...
namespace Highsoft.Web.Mvc.Charts
{
  public class PlotOptionsArearangeStatesHover : BaseObject
  {
    ...
    public PlotOptionsArearangeStatesHover()
    {
      ...
      this.Halo = this.Halo_DefaultValue = new PlotOptionsArearangeStatesHoverHalo();
      ...
      this.Marker = this.Marker_DefaultValue = new PlotOptionsArearangeStatesHoverMarker();
    }
