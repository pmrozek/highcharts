...
// Type: Highsoft.Web.Mvc.Charts.PlotOptionsHeatmapStatesHover
...
namespace Highsoft.Web.Mvc.Charts
{
  public class PlotOptionsHeatmapStatesHover : BaseObject
  {
    ...
    public PlotOptionsHeatmapStatesHover()
    {
      ...
      this.Halo = this.Halo_DefaultValue = new PlotOptionsHeatmapStatesHoverHalo();
      ...
      this.Marker = this.Marker_DefaultValue = new PlotOptionsHeatmapStatesHoverMarker();
    }
