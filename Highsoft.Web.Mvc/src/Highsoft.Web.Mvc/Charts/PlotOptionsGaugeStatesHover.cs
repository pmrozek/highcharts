// Type: Highsoft.Web.Mvc.Charts.PlotOptionsGaugeStatesHover
...
{
    public class PlotOptionsGaugeStatesHover : BaseObject
    {
        ...
        public PlotOptionsGaugeStatesHover()
        {
            ...
            this.Halo = this.Halo_DefaultValue = new PlotOptionsGaugeStatesHoverHalo();
            ...
            this.Marker = this.Marker_DefaultValue = new PlotOptionsGaugeStatesHoverMarker();
        }
