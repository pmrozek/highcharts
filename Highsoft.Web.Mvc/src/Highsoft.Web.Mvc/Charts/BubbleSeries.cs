...
namespace Highsoft.Web.Mvc.Charts
{
    public class BubbleSeries : Series
    {
        public BubbleSeries()
        {
            ...
            this.ZMax_DefaultValue = nullable7;
            this.ZMax = nullable7;
            double? nullable8 = new double?();
            this.ZMin_DefaultValue = nullable8;
            this.ZMin = nullable8;
            nullable8 = new double?(0.0);
            this.ZThreshold_DefaultValue = nullable8;
            this.ZThreshold = nullable8;
            this.ZoneAxis = this.ZoneAxis_DefaultValue = "y";
            this.Zones = this.Zones_DefaultValue = new List<BubbleSeriesZone>();
        }
