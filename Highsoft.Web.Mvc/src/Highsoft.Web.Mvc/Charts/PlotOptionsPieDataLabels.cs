...
// Type: Highsoft.Web.Mvc.Charts.PlotOptionsPieDataLabels
...
namespace Highsoft.Web.Mvc.Charts
{
  public class PlotOptionsPieDataLabels : BaseObject
  {
    ...
    public PlotOptionsPieDataLabels()
    {
      ...
      this.Overflow = this.Overflow_DefaultValue = PlotOptionsPieDataLabelsOverflow.Justify;
      nullable1 = new double?(5.0);
      ...
      this.VerticalAlign = this.VerticalAlign_DefaultValue = PlotOptionsPieDataLabelsVerticalAlign.Null;
      nullable1 = new double?(0.0);
    ...
    internal override Hashtable ToHashtable()
    {
      ...
      if ((crop.GetValueOrDefault() == nullable3.GetValueOrDefault() ? (crop.HasValue != nullable3.HasValue ? 1 : 0) : 1) != 0)
