...
// Type: Highsoft.Web.Mvc.Charts.PlotOptionsBarDataLabels
...
namespace Highsoft.Web.Mvc.Charts
{
  public class PlotOptionsBarDataLabels : BaseObject
  {
    ...
    public PlotOptionsBarDataLabels()
    {
      ...
      this.Overflow = this.Overflow_DefaultValue = PlotOptionsBarDataLabelsOverflow.Justify;
      ...
      this.VerticalAlign = this.VerticalAlign_DefaultValue = PlotOptionsBarDataLabelsVerticalAlign.Null;
      nullable2 = new double?(5.0);
    ...
    internal override Hashtable ToHashtable()
    {
      ...
      bool? nullable1 = this.AllowOverlap_DefaultValue;
      if ((allowOverlap.GetValueOrDefault() == nullable1.GetValueOrDefault() ? (allowOverlap.HasValue != nullable1.HasValue ? 1 : 0) : 1) != 0)
      ...
      if ((borderRadius.GetValueOrDefault() == nullable2.GetValueOrDefault() ? (borderRadius.HasValue != nullable2.HasValue ? 1 : 0) : 1) != 0)
        hashtable.Add((object) "borderRadius", (object) this.BorderRadius);
      nullable2 = this.BorderWidth;
      double? nullable3 = this.BorderWidth_DefaultValue;
      ...
      nullable1 = this.Defer_DefaultValue;
      ...
      nullable1 = this.Inside_DefaultValue;
      if ((nullable4.GetValueOrDefault() == nullable1.GetValueOrDefault() ? (nullable4.HasValue != nullable1.HasValue ? 1 : 0) : 1) != 0)
