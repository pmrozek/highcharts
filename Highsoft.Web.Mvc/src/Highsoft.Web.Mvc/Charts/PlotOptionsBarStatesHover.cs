...
// Type: Highsoft.Web.Mvc.Charts.PlotOptionsBarStatesHover
...
namespace Highsoft.Web.Mvc.Charts
{
  public class PlotOptionsBarStatesHover : BaseObject
  {
    ...
    public PlotOptionsBarStatesHover()
    {
      ...
      this.Halo = this.Halo_DefaultValue = new PlotOptionsBarStatesHoverHalo();
      ...
      this.Marker = this.Marker_DefaultValue = new PlotOptionsBarStatesHoverMarker();
    }
