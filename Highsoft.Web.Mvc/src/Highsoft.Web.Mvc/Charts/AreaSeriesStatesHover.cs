...
// Type: Highsoft.Web.Mvc.Charts.AreaSeriesStatesHover
...
namespace Highsoft.Web.Mvc.Charts
{
  public class AreaSeriesStatesHover : BaseObject
  {
    ...
    public AreaSeriesStatesHover()
    {
      ...
      this.Halo = this.Halo_DefaultValue = new AreaSeriesStatesHoverHalo();
      ...
      this.Marker = this.Marker_DefaultValue = new AreaSeriesStatesHoverMarker();
    }
