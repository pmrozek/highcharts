...
// Type: Highsoft.Web.Mvc.Charts.PyramidSeriesStatesHover
...
namespace Highsoft.Web.Mvc.Charts
{
  public class PyramidSeriesStatesHover : BaseObject
  {
    ...
    public PyramidSeriesStatesHover()
    {
      ...
      this.Halo = this.Halo_DefaultValue = new PyramidSeriesStatesHoverHalo();
      ...
      this.Marker = this.Marker_DefaultValue = new PyramidSeriesStatesHoverMarker();
    }
