...
// Type: Highsoft.Web.Mvc.Charts.BarSeriesStatesHover
...
namespace Highsoft.Web.Mvc.Charts
{
  public class BarSeriesStatesHover : BaseObject
  {
    ...
    public BarSeriesStatesHover()
    {
      ...
      this.Halo = this.Halo_DefaultValue = new BarSeriesStatesHoverHalo();
      ...
      this.Marker = this.Marker_DefaultValue = new BarSeriesStatesHoverMarker();
    }
