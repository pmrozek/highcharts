...
// Type: Highsoft.Web.Mvc.Charts.PlotOptionsFunnelStatesHover
...
namespace Highsoft.Web.Mvc.Charts
{
  public class PlotOptionsFunnelStatesHover : BaseObject
  {
    ...
    public PlotOptionsFunnelStatesHover()
    {
      ...
      this.Halo = this.Halo_DefaultValue = new PlotOptionsFunnelStatesHoverHalo();
      ...
      this.Marker = this.Marker_DefaultValue = new PlotOptionsFunnelStatesHoverMarker();
    }
