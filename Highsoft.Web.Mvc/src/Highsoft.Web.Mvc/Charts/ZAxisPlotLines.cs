// Type: Highsoft.Web.Mvc.Charts.ZAxisPlotLines
...
namespace Highsoft.Web.Mvc.Charts
{
    public class ZAxisPlotLines : BaseObject
    {
        ...
        public ZAxisPlotLines()
        {
            ...
            this.DashStyle = this.DashStyle_DefaultValue = ZAxisPlotLinesDashStyle.Solid;
            this.Events = this.Events_DefaultValue = (object) null;
            this.Id = this.Id_DefaultValue = (string) null;
            this.Label = this.Label_DefaultValue = new ZAxisPlotLinesLabel();
