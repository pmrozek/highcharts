...
// Type: Highsoft.Web.Mvc.Charts.SolidgaugeSeriesStatesHover
...
{
  public class SolidgaugeSeriesStatesHover : BaseObject
  {
    ...
    public SolidgaugeSeriesStatesHover()
    {
      ...
      this.Halo = this.Halo_DefaultValue = new SolidgaugeSeriesStatesHoverHalo();
      ...
      this.Marker = this.Marker_DefaultValue = new SolidgaugeSeriesStatesHoverMarker();
    }
