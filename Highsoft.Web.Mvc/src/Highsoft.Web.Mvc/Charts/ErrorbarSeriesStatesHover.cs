...
// Type: Highsoft.Web.Mvc.Charts.ErrorbarSeriesStatesHover
...
namespace Highsoft.Web.Mvc.Charts
{
  public class ErrorbarSeriesStatesHover : BaseObject
  {
    ...
    public ErrorbarSeriesStatesHover()
    {
      ...
      this.Halo = this.Halo_DefaultValue = new ErrorbarSeriesStatesHoverHalo();
      ...
      this.Marker = this.Marker_DefaultValue = new ErrorbarSeriesStatesHoverMarker();
    }
