...
namespace Highsoft.Web.Mvc.Charts
{
    public class YAxis : BaseObject
    {
        ...
        internal override Hashtable ToHashtable()
        {
            ...
            if ((allowDecimals.GetValueOrDefault() == decimalsDefaultValue.GetValueOrDefault()
                    ? (allowDecimals.HasValue != decimalsDefaultValue.HasValue ? 1 : 0)
                    : 1) != 0)
            ...
            double? nullable1 = this.Angle_DefaultValue;
            if ((angle.GetValueOrDefault() == nullable1.GetValueOrDefault()
                    ? (angle.HasValue != nullable1.HasValue ? 1 : 0)
                    : 1) != 0)
            ...
            nullable1 = this.Ceiling;
            double? nullable2 = this.Ceiling_DefaultValue;
            ...
            bool? nullable3 = this.EndOnTick_DefaultValue;
            if ((endOnTick.GetValueOrDefault() == nullable3.GetValueOrDefault()
                    ? (endOnTick.HasValue != nullable3.HasValue ? 1 : 0)
                    : 1) != 0)
                hashtable.Add((object) "endOnTick", (object) this.EndOnTick);
            if (this.Events.IsDirty())
                hashtable.Add((object) "events", (object) this.Events.ToHashtable());
            nullable2 = this.Floor;
            nullable1 = this.Floor_DefaultValue;
            ...
            nullable1 = this.GridLineWidth;
            nullable2 = this.GridLineWidth_DefaultValue;
            if ((nullable1.GetValueOrDefault() == nullable2.GetValueOrDefault()
                    ? (nullable1.HasValue != nullable2.HasValue ? 1 : 0)
                    : 1) != 0)
                hashtable.Add((object) "gridLineWidth", (object) this.GridLineWidth);
            nullable2 = this.GridZIndex;
            nullable1 = this.GridZIndex_DefaultValue;
            if ((nullable2.GetValueOrDefault() == nullable1.GetValueOrDefault()
                    ? (nullable2.HasValue != nullable1.HasValue ? 1 : 0)
                    : 1) != 0)
            ...
            nullable2 = this.LinkedTo;
            nullable1 = this.LinkedTo_DefaultValue;
            if ((nullable2.GetValueOrDefault() == nullable1.GetValueOrDefault()
                    ? (nullable2.HasValue != nullable1.HasValue ? 1 : 0)
                    : 1) != 0)
                hashtable.Add((object) "linkedTo", (object) this.LinkedTo);
            nullable1 = this.Max;
            nullable2 = this.Max_DefaultValue;
            if ((nullable1.GetValueOrDefault() == nullable2.GetValueOrDefault()
                    ? (nullable1.HasValue != nullable2.HasValue ? 1 : 0)
                    : 1) != 0)
            ...
            nullable2 = this.MaxPadding;
            nullable1 = this.MaxPadding_DefaultValue;
            if ((nullable2.GetValueOrDefault() == nullable1.GetValueOrDefault()
                    ? (nullable2.HasValue != nullable1.HasValue ? 1 : 0)
                    : 1) != 0)
                hashtable.Add((object) "maxPadding", (object) this.MaxPadding);
            nullable1 = this.Min;
            nullable2 = this.Min_DefaultValue;
            if ((nullable1.GetValueOrDefault() == nullable2.GetValueOrDefault()
                    ? (nullable1.HasValue != nullable2.HasValue ? 1 : 0)
                    : 1) != 0)
            ...
            nullable2 = this.MinPadding;
            nullable1 = this.MinPadding_DefaultValue;
            if ((nullable2.GetValueOrDefault() == nullable1.GetValueOrDefault()
                    ? (nullable2.HasValue != nullable1.HasValue ? 1 : 0)
                    : 1) != 0)
                hashtable.Add((object) "minPadding", (object) this.MinPadding);
            nullable1 = this.MinRange;
            nullable2 = this.MinRange_DefaultValue;
            if ((nullable1.GetValueOrDefault() == nullable2.GetValueOrDefault()
                    ? (nullable1.HasValue != nullable2.HasValue ? 1 : 0)
                    : 1) != 0)
                hashtable.Add((object) "minRange", (object) this.MinRange);
            nullable2 = this.MinTickInterval;
            nullable1 = this.MinTickInterval_DefaultValue;
            if ((nullable2.GetValueOrDefault() == nullable1.GetValueOrDefault()
                    ? (nullable2.HasValue != nullable1.HasValue ? 1 : 0)
                    : 1) != 0)
            ...
            nullable1 = this.MinorGridLineWidth;
            nullable2 = this.MinorGridLineWidth_DefaultValue;
            if ((nullable1.GetValueOrDefault() == nullable2.GetValueOrDefault()
                    ? (nullable1.HasValue != nullable2.HasValue ? 1 : 0)
                    : 1) != 0)
            ...
            nullable2 = this.MinorTickLength;
            nullable1 = this.MinorTickLength_DefaultValue;
            if ((nullable2.GetValueOrDefault() == nullable1.GetValueOrDefault()
                    ? (nullable2.HasValue != nullable1.HasValue ? 1 : 0)
                    : 1) != 0)
            ...
            nullable1 = this.MinorTickWidth;
            nullable2 = this.MinorTickWidth_DefaultValue;
            if ((nullable1.GetValueOrDefault() == nullable2.GetValueOrDefault()
                    ? (nullable1.HasValue != nullable2.HasValue ? 1 : 0)
                    : 1) != 0)
            ...
            nullable3 = this.ShowLastLabel_DefaultValue;
            if ((nullable4.GetValueOrDefault() == nullable3.GetValueOrDefault()
                    ? (nullable4.HasValue != nullable3.HasValue ? 1 : 0)
                    : 1) != 0)
                hashtable.Add((object) "showLastLabel", (object) this.ShowLastLabel);
            nullable1 = this.SoftMax;
            nullable2 = this.SoftMax_DefaultValue;
            if ((nullable1.GetValueOrDefault() == nullable2.GetValueOrDefault()
                    ? (nullable1.HasValue != nullable2.HasValue ? 1 : 0)
                    : 1) != 0)
                hashtable.Add((object) "softMax", (object) this.SoftMax);
            nullable2 = this.SoftMin;
            nullable1 = this.SoftMin_DefaultValue;
            if ((nullable2.GetValueOrDefault() == nullable1.GetValueOrDefault()
                    ? (nullable2.HasValue != nullable1.HasValue ? 1 : 0)
                    : 1) != 0)
            ...
            nullable2 = this.StartOfWeek_DefaultValue;
            if ((nullable1.GetValueOrDefault() == nullable2.GetValueOrDefault()
                    ? (nullable1.HasValue != nullable2.HasValue ? 1 : 0)
                    : 1) != 0)
                hashtable.Add((object) "startOfWeek", (object) this.StartOfWeek);
            nullable3 = this.StartOnTick;
            ...
            nullable2 = this.TickInterval_DefaultValue;
            if ((nullable1.GetValueOrDefault() == nullable2.GetValueOrDefault()
                    ? (nullable1.HasValue != nullable2.HasValue ? 1 : 0)
                    : 1) != 0)
                hashtable.Add((object) "tickInterval", (object) this.TickInterval);
            nullable2 = this.TickLength;
            ...
            nullable2 = this.TickPixelInterval_DefaultValue;
            if ((nullable1.GetValueOrDefault() == nullable2.GetValueOrDefault()
                    ? (nullable1.HasValue != nullable2.HasValue ? 1 : 0)
                    : 1) != 0)
