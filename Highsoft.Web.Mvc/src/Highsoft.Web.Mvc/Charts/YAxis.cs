...
namespace Highsoft.Web.Mvc.Charts
{
  public class YAxis : BaseObject
  {
    ...
    public YAxis()
    {
      ...
      this.Max = nullable5;
      this.MaxColor = this.MaxColor_DefaultValue = "#102D4C";
      ...
      this.Min = nullable6;
      this.MinColor = this.MinColor_DefaultValue = "#EFEFFF";
    ...
    internal override Hashtable ToHashtable()
    {
      ...
      if (this.GridLineInterpolation != this.GridLineInterpolation_DefaultValue)
        hashtable.Add((object) "gridLineInterpolation", (object) Highcharts.FirstCharacterToLower(this.GridLineInterpolation.ToString()));
