// Type: Highsoft.Web.Mvc.Charts.PlotOptionsBubbleDataLabels
...
namespace Highsoft.Web.Mvc.Charts
{
    public class PlotOptionsBubbleDataLabels : BaseObject
    {
        ...
        {
            this.Align = this.Align_DefaultValue = PlotOptionsBubbleDataLabelsAlign.Center;
            ...
            this.Overflow = this.Overflow_DefaultValue = PlotOptionsBubbleDataLabelsOverflow.Justify;
            ...
            this.VerticalAlign = this.VerticalAlign_DefaultValue = PlotOptionsBubbleDataLabelsVerticalAlign.Null;
            nullable2 = new double?(0.0);
