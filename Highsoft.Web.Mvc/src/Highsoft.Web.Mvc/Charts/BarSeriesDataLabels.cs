...
// Type: Highsoft.Web.Mvc.Charts.BarSeriesDataLabels
...
namespace Highsoft.Web.Mvc.Charts
{
  public class BarSeriesDataLabels : BaseObject
  {
    ...
    public BarSeriesDataLabels()
    {
      ...
      this.Overflow = this.Overflow_DefaultValue = BarSeriesDataLabelsOverflow.Justify;
      ...
      this.VerticalAlign = this.VerticalAlign_DefaultValue = BarSeriesDataLabelsVerticalAlign.Null;
      nullable2 = new double?(5.0);
