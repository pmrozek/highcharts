// Type: Highsoft.Web.Mvc.Charts.HeatmapSeriesDataLabels
...
namespace Highsoft.Web.Mvc.Charts
{
    public class HeatmapSeriesDataLabels : BaseObject
    {
        ...
        {
            this.Align = this.Align_DefaultValue = HeatmapSeriesDataLabelsAlign.Center;
            ...
            this.Overflow = this.Overflow_DefaultValue = HeatmapSeriesDataLabelsOverflow.Justify;
            ...
            this.VerticalAlign = this.VerticalAlign_DefaultValue = HeatmapSeriesDataLabelsVerticalAlign.Null;
            nullable2 = new double?(0.0);
