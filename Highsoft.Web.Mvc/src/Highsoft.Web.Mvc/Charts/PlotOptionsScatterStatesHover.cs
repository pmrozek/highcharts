...
// Type: Highsoft.Web.Mvc.Charts.PlotOptionsScatterStatesHover
...
namespace Highsoft.Web.Mvc.Charts
{
  public class PlotOptionsScatterStatesHover : BaseObject
  {
    ...
    public PlotOptionsScatterStatesHover()
    {
      ...
      this.Halo = this.Halo_DefaultValue = new PlotOptionsScatterStatesHoverHalo();
      ...
      this.Marker = this.Marker_DefaultValue = new PlotOptionsScatterStatesHoverMarker();
    }
