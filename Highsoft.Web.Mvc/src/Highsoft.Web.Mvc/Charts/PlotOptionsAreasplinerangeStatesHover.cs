...
// Type: Highsoft.Web.Mvc.Charts.PlotOptionsAreasplinerangeStatesHover
...
namespace Highsoft.Web.Mvc.Charts
{
  public class PlotOptionsAreasplinerangeStatesHover : BaseObject
  {
    ...
    public PlotOptionsAreasplinerangeStatesHover()
    {
      ...
      this.Halo = this.Halo_DefaultValue = new PlotOptionsAreasplinerangeStatesHoverHalo();
      ...
      this.Marker = this.Marker_DefaultValue = new PlotOptionsAreasplinerangeStatesHoverMarker();
    }
