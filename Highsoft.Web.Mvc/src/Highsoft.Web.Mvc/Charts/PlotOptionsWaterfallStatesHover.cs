...
// Type: Highsoft.Web.Mvc.Charts.PlotOptionsWaterfallStatesHover
...
namespace Highsoft.Web.Mvc.Charts
{
  public class PlotOptionsWaterfallStatesHover : BaseObject
  {
    ...
    public PlotOptionsWaterfallStatesHover()
    {
      ...
      this.Halo = this.Halo_DefaultValue = new PlotOptionsWaterfallStatesHoverHalo();
      ...
      this.Marker = this.Marker_DefaultValue = new PlotOptionsWaterfallStatesHoverMarker();
    }
