...
// Type: Highsoft.Web.Mvc.Charts.PlotOptionsAreasplineStatesHover
...
namespace Highsoft.Web.Mvc.Charts
{
  public class PlotOptionsAreasplineStatesHover : BaseObject
  {
    ...
    public PlotOptionsAreasplineStatesHover()
    {
      ...
      this.Halo = this.Halo_DefaultValue = new PlotOptionsAreasplineStatesHoverHalo();
      ...
      this.Marker = this.Marker_DefaultValue = new PlotOptionsAreasplineStatesHoverMarker();
    }
