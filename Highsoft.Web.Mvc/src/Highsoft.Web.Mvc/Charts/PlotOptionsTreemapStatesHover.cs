...
// Type: Highsoft.Web.Mvc.Charts.PlotOptionsTreemapStatesHover
...
namespace Highsoft.Web.Mvc.Charts
{
  public class PlotOptionsTreemapStatesHover : BaseObject
  {
    ...
    public PlotOptionsTreemapStatesHover()
    {
      ...
      this.Halo = this.Halo_DefaultValue = new PlotOptionsTreemapStatesHoverHalo();
      ...
      this.Marker = this.Marker_DefaultValue = new PlotOptionsTreemapStatesHoverMarker();
    }
