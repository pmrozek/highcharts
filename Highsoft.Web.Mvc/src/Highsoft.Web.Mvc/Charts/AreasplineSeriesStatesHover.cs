...
// Type: Highsoft.Web.Mvc.Charts.AreasplineSeriesStatesHover
...
namespace Highsoft.Web.Mvc.Charts
{
  public class AreasplineSeriesStatesHover : BaseObject
  {
    ...
    public AreasplineSeriesStatesHover()
    {
      ...
      this.Halo = this.Halo_DefaultValue = new AreasplineSeriesStatesHoverHalo();
      ...
      this.Marker = this.Marker_DefaultValue = new AreasplineSeriesStatesHoverMarker();
    }
