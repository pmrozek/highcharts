// Type: Highsoft.Web.Mvc.Charts.PlotOptionsWaterfallDataLabels
...
namespace Highsoft.Web.Mvc.Charts
{
    public class PlotOptionsWaterfallDataLabels : BaseObject
    {
        ...
        {
            this.Align = this.Align_DefaultValue = PlotOptionsWaterfallDataLabelsAlign.Center;
            ...
            this.Overflow = this.Overflow_DefaultValue = PlotOptionsWaterfallDataLabelsOverflow.Justify;
            ...
            this.VerticalAlign = this.VerticalAlign_DefaultValue = PlotOptionsWaterfallDataLabelsVerticalAlign.Null;
            nullable2 = new double?(0.0);
