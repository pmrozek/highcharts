...
// Type: Highsoft.Web.Mvc.Charts.PlotOptionsBubbleStatesHover
...
namespace Highsoft.Web.Mvc.Charts
{
  public class PlotOptionsBubbleStatesHover : BaseObject
  {
    ...
    public PlotOptionsBubbleStatesHover()
    {
      ...
      this.Halo = this.Halo_DefaultValue = new PlotOptionsBubbleStatesHoverHalo();
      ...
      this.Marker = this.Marker_DefaultValue = new PlotOptionsBubbleStatesHoverMarker();
    }
