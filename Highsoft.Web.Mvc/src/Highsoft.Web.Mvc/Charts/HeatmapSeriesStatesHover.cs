...
// Type: Highsoft.Web.Mvc.Charts.HeatmapSeriesStatesHover
...
namespace Highsoft.Web.Mvc.Charts
{
  public class HeatmapSeriesStatesHover : BaseObject
  {
    ...
    public HeatmapSeriesStatesHover()
    {
      ...
      this.Halo = this.Halo_DefaultValue = new HeatmapSeriesStatesHoverHalo();
      ...
      this.Marker = this.Marker_DefaultValue = new HeatmapSeriesStatesHoverMarker();
    }
