...
// Type: Highsoft.Web.Mvc.Charts.AreasplinerangeSeriesStatesHover
...
namespace Highsoft.Web.Mvc.Charts
{
  public class AreasplinerangeSeriesStatesHover : BaseObject
  {
    ...
    public AreasplinerangeSeriesStatesHover()
    {
      ...
      this.Halo = this.Halo_DefaultValue = new AreasplinerangeSeriesStatesHoverHalo();
      ...
      this.Marker = this.Marker_DefaultValue = new AreasplinerangeSeriesStatesHoverMarker();
    }
