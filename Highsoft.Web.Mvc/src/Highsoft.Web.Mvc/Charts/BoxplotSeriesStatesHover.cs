...
// Type: Highsoft.Web.Mvc.Charts.BoxplotSeriesStatesHover
...
namespace Highsoft.Web.Mvc.Charts
{
  public class BoxplotSeriesStatesHover : BaseObject
  {
    ...
    public BoxplotSeriesStatesHover()
    {
      ...
      this.Halo = this.Halo_DefaultValue = new BoxplotSeriesStatesHoverHalo();
      ...
      this.Marker = this.Marker_DefaultValue = new BoxplotSeriesStatesHoverMarker();
    }
