...
// Type: Highsoft.Web.Mvc.Charts.GaugeSeriesStatesHover
...
{
  public class GaugeSeriesStatesHover : BaseObject
  {
    ...
    public GaugeSeriesStatesHover()
    {
      ...
      this.Halo = this.Halo_DefaultValue = new GaugeSeriesStatesHoverHalo();
      ...
      this.Marker = this.Marker_DefaultValue = new GaugeSeriesStatesHoverMarker();
    }
