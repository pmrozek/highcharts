...
// Type: Highsoft.Web.Mvc.Charts.PlotOptionsAreasplinerangeTooltip
...
namespace Highsoft.Web.Mvc.Charts
{
  public class PlotOptionsAreasplinerangeTooltip : BaseObject
  {
    ...
    public PlotOptionsAreasplinerangeTooltip()
    {
      ...
      this.PointFormat = this.PointFormat_DefaultValue = "<span style='color:{point.color}'>●</span> {series.name}: <b>{point.y}</b><br/>";
    ...
    internal override Hashtable ToHashtable()
    {
      ...
      nullable4 = this.ValueDecimals;
      nullable3 = this.ValueDecimals_DefaultValue;
