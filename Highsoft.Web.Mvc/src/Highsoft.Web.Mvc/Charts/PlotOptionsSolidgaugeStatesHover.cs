// Type: Highsoft.Web.Mvc.Charts.PlotOptionsSolidgaugeStatesHover
...
{
    public class PlotOptionsSolidgaugeStatesHover : BaseObject
    {
        ...
        public PlotOptionsSolidgaugeStatesHover()
        {
            ...
            this.Halo = this.Halo_DefaultValue = new PlotOptionsSolidgaugeStatesHoverHalo();
            ...
            this.Marker = this.Marker_DefaultValue = new PlotOptionsSolidgaugeStatesHoverMarker();
        }
