...
// Type: Highsoft.Web.Mvc.Charts.WaterfallSeriesStatesHover
...
namespace Highsoft.Web.Mvc.Charts
{
  public class WaterfallSeriesStatesHover : BaseObject
  {
    ...
    public WaterfallSeriesStatesHover()
    {
      ...
      this.Halo = this.Halo_DefaultValue = new WaterfallSeriesStatesHoverHalo();
      ...
      this.Marker = this.Marker_DefaultValue = new WaterfallSeriesStatesHoverMarker();
    }
