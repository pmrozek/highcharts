...
// Type: Highsoft.Web.Mvc.Charts.PieSeriesDataLabels
...
namespace Highsoft.Web.Mvc.Charts
{
  public class PieSeriesDataLabels : BaseObject
  {
    ...
    public PieSeriesDataLabels()
    {
      ...
      this.Overflow = this.Overflow_DefaultValue = PieSeriesDataLabelsOverflow.Justify;
      nullable1 = new double?(5.0);
      ...
      this.VerticalAlign = this.VerticalAlign_DefaultValue = PieSeriesDataLabelsVerticalAlign.Null;
      nullable1 = new double?(0.0);
