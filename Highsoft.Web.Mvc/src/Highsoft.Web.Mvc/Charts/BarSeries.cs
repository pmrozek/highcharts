// Type: Highsoft.Web.Mvc.Charts.BarSeries
...
namespace Highsoft.Web.Mvc.Charts
{
    public class BarSeries : Series
    {
        public BarSeries()
        {
            ...
            this.Cursor = this.Cursor_DefaultValue = BarSeriesCursor.Null;
            this.Data = this.Data_DefaultValue = new List<BarSeriesData>();
            ...
            this.Events = this.Events_DefaultValue = new BarSeriesEvents();
            nullable1 = new bool?(false);
            ...
            this.Point = this.Point_DefaultValue = new BarSeriesPoint();
            nullable6 = new double?(1.0);
            this.PointInterval_DefaultValue = nullable6;
            this.PointInterval = nullable6;
            this.PointIntervalUnit = this.PointIntervalUnit_DefaultValue = BarSeriesPointIntervalUnit.Null;
            ...
            this.Stacking = this.Stacking_DefaultValue = BarSeriesStacking.Null;
            this.States = this.States_DefaultValue = new BarSeriesStates();
            nullable1 = new bool?(true);
            ...
            this.Tooltip = this.Tooltip_DefaultValue = new BarSeriesTooltip();
            nullable8 = new double?(1000.0);
            this.TurboThreshold_DefaultValue = nullable8;
            this.TurboThreshold = nullable8;
            this.Type = this.Type_DefaultValue = BarSeriesType.Null;
            nullable1 = new bool?(true);
            ...
            this.Zones = this.Zones_DefaultValue = new List<BarSeriesZone>();
        }
