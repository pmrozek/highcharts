// Type: Highsoft.Web.Mvc.Charts.BubbleSeriesDataLabels
...
namespace Highsoft.Web.Mvc.Charts
{
    public class BubbleSeriesDataLabels : BaseObject
    {
        ...
        {
            this.Align = this.Align_DefaultValue = BubbleSeriesDataLabelsAlign.Center;
            ...
            this.Overflow = this.Overflow_DefaultValue = BubbleSeriesDataLabelsOverflow.Justify;
            ...
            this.VerticalAlign = this.VerticalAlign_DefaultValue = BubbleSeriesDataLabelsVerticalAlign.Null;
            nullable2 = new double?(0.0);
