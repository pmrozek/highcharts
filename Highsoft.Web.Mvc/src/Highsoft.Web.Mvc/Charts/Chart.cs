...
namespace Highsoft.Web.Mvc.Charts
{
  public class Chart : BaseObject
  {
    ...
    public Chart()
    {
      ...
      this.BorderColor = this.BorderColor_DefaultValue = "#4572A7";
      ...
      this.PlotBorderColor = this.PlotBorderColor_DefaultValue = "#C0C0C0";
      ...
      this.SelectionMarkerFill = this.SelectionMarkerFill_DefaultValue = "rgba(69,114,167,0.25)";
      ...
      hashtable1.Add((object) "fontFamily", (object) "\"Lucida Grande\", \"Lucida Sans Unicode\", Verdana, Arial, Helvetica, sans-serif");
    ...
    internal override Hashtable ToHashtable()
    {
      ...
      bool? ticksDefaultValue = this.AlignTicks_DefaultValue;
      if ((alignTicks.GetValueOrDefault() == ticksDefaultValue.GetValueOrDefault() ? (alignTicks.HasValue != ticksDefaultValue.HasValue ? 1 : 0) : 1) != 0)
      ...
      bool? ignoreHiddenSeries = this.IgnoreHiddenSeries;
      bool? nullable3 = this.IgnoreHiddenSeries_DefaultValue;
      if ((ignoreHiddenSeries.GetValueOrDefault() == nullable3.GetValueOrDefault() ? (ignoreHiddenSeries.HasValue != nullable3.HasValue ? 1 : 0) : 1) != 0)
        hashtable.Add((object) "ignoreHiddenSeries", (object) this.IgnoreHiddenSeries);
      nullable3 = this.Inverted;
      bool? nullable4 = this.Inverted_DefaultValue;
      ...
      nullable1 = this.MarginBottom;
      nullable2 = this.MarginBottom_DefaultValue;
      if ((nullable1.GetValueOrDefault() == nullable2.GetValueOrDefault() ? (nullable1.HasValue != nullable2.HasValue ? 1 : 0) : 1) != 0)
        hashtable.Add((object) "marginBottom", (object) this.MarginBottom);
      nullable2 = this.MarginLeft;
      nullable1 = this.MarginLeft_DefaultValue;
      if ((nullable2.GetValueOrDefault() == nullable1.GetValueOrDefault() ? (nullable2.HasValue != nullable1.HasValue ? 1 : 0) : 1) != 0)
        hashtable.Add((object) "marginLeft", (object) this.MarginLeft);
      nullable1 = this.MarginRight;
      nullable2 = this.MarginRight_DefaultValue;
      if ((nullable1.GetValueOrDefault() == nullable2.GetValueOrDefault() ? (nullable1.HasValue != nullable2.HasValue ? 1 : 0) : 1) != 0)
        hashtable.Add((object) "marginRight", (object) this.MarginRight);
      nullable2 = this.MarginTop;
      nullable1 = this.MarginTop_DefaultValue;
      if ((nullable2.GetValueOrDefault() == nullable1.GetValueOrDefault() ? (nullable2.HasValue != nullable1.HasValue ? 1 : 0) : 1) != 0)
      ...
      nullable4 = this.Panning;
      nullable3 = this.Panning_DefaultValue;
      ...
      nullable1 = this.PlotBorderWidth;
      nullable2 = this.PlotBorderWidth_DefaultValue;
      if ((nullable1.GetValueOrDefault() == nullable2.GetValueOrDefault() ? (nullable1.HasValue != nullable2.HasValue ? 1 : 0) : 1) != 0)
      ...
      nullable3 = this.Polar;
      nullable4 = this.Polar_DefaultValue;
      if ((nullable3.GetValueOrDefault() == nullable4.GetValueOrDefault() ? (nullable3.HasValue != nullable4.HasValue ? 1 : 0) : 1) != 0)
        hashtable.Add((object) "polar", (object) this.Polar);
      nullable4 = this.Reflow;
      nullable3 = this.Reflow_DefaultValue;
      if ((nullable4.GetValueOrDefault() == nullable3.GetValueOrDefault() ? (nullable4.HasValue != nullable3.HasValue ? 1 : 0) : 1) != 0)
      ...
      nullable3 = this.ShowAxes;
      nullable4 = this.ShowAxes_DefaultValue;
      if ((nullable3.GetValueOrDefault() == nullable4.GetValueOrDefault() ? (nullable3.HasValue != nullable4.HasValue ? 1 : 0) : 1) != 0)
        hashtable.Add((object) "showAxes", (object) this.ShowAxes);
      nullable2 = this.SpacingBottom;
      nullable1 = this.SpacingBottom_DefaultValue;
      if ((nullable2.GetValueOrDefault() == nullable1.GetValueOrDefault() ? (nullable2.HasValue != nullable1.HasValue ? 1 : 0) : 1) != 0)
        hashtable.Add((object) "spacingBottom", (object) this.SpacingBottom);
      nullable1 = this.SpacingLeft;
      nullable2 = this.SpacingLeft_DefaultValue;
      if ((nullable1.GetValueOrDefault() == nullable2.GetValueOrDefault() ? (nullable1.HasValue != nullable2.HasValue ? 1 : 0) : 1) != 0)
        hashtable.Add((object) "spacingLeft", (object) this.SpacingLeft);
      nullable2 = this.SpacingRight;
      nullable1 = this.SpacingRight_DefaultValue;
      if ((nullable2.GetValueOrDefault() == nullable1.GetValueOrDefault() ? (nullable2.HasValue != nullable1.HasValue ? 1 : 0) : 1) != 0)
        hashtable.Add((object) "spacingRight", (object) this.SpacingRight);
      nullable1 = this.SpacingTop;
      nullable2 = this.SpacingTop_DefaultValue;
      if ((nullable1.GetValueOrDefault() == nullable2.GetValueOrDefault() ? (nullable1.HasValue != nullable2.HasValue ? 1 : 0) : 1) != 0)
