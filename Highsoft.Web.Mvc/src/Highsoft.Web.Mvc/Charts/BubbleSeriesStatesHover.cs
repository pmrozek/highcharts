...
// Type: Highsoft.Web.Mvc.Charts.BubbleSeriesStatesHover
...
namespace Highsoft.Web.Mvc.Charts
{
  public class BubbleSeriesStatesHover : BaseObject
  {
    ...
    public BubbleSeriesStatesHover()
    {
      ...
      this.Halo = this.Halo_DefaultValue = new BubbleSeriesStatesHoverHalo();
      ...
      this.Marker = this.Marker_DefaultValue = new BubbleSeriesStatesHoverMarker();
    }
