...
// Type: Highsoft.Web.Mvc.Charts.FunnelSeriesDataLabels
...
namespace Highsoft.Web.Mvc.Charts
{
  public class FunnelSeriesDataLabels : BaseObject
  {
    ...
    public FunnelSeriesDataLabels()
    {
      ...
      this.Overflow = this.Overflow_DefaultValue = FunnelSeriesDataLabelsOverflow.Justify;
      nullable1 = new double?(5.0);
      ...
      this.VerticalAlign = this.VerticalAlign_DefaultValue = FunnelSeriesDataLabelsVerticalAlign.Null;
      nullable1 = new double?(0.0);
