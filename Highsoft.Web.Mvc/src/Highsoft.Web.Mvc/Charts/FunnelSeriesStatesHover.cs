...
// Type: Highsoft.Web.Mvc.Charts.FunnelSeriesStatesHover
...
namespace Highsoft.Web.Mvc.Charts
{
  public class FunnelSeriesStatesHover : BaseObject
  {
    ...
    public FunnelSeriesStatesHover()
    {
      ...
      this.Halo = this.Halo_DefaultValue = new FunnelSeriesStatesHoverHalo();
      ...
      this.Marker = this.Marker_DefaultValue = new FunnelSeriesStatesHoverMarker();
    }
