...
// Type: Highsoft.Web.Mvc.Charts.PlotOptionsPyramidStatesHover
...
namespace Highsoft.Web.Mvc.Charts
{
  public class PlotOptionsPyramidStatesHover : BaseObject
  {
    ...
    public PlotOptionsPyramidStatesHover()
    {
      ...
      this.Halo = this.Halo_DefaultValue = new PlotOptionsPyramidStatesHoverHalo();
      ...
      this.Marker = this.Marker_DefaultValue = new PlotOptionsPyramidStatesHoverMarker();
    }
