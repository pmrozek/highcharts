...
// Type: Highsoft.Web.Mvc.Charts.PlotOptionsColumnrangeStatesHover
...
namespace Highsoft.Web.Mvc.Charts
{
  public class PlotOptionsColumnrangeStatesHover : BaseObject
  {
    ...
    public PlotOptionsColumnrangeStatesHover()
    {
      ...
      this.Halo = this.Halo_DefaultValue = new PlotOptionsColumnrangeStatesHoverHalo();
      ...
      this.Marker = this.Marker_DefaultValue = new PlotOptionsColumnrangeStatesHoverMarker();
    }
