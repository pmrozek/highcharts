...
// Type: Highsoft.Web.Mvc.Charts.ScatterSeriesStatesHover
...
namespace Highsoft.Web.Mvc.Charts
{
  public class ScatterSeriesStatesHover : BaseObject
  {
    ...
    public ScatterSeriesStatesHover()
    {
      ...
      this.Halo = this.Halo_DefaultValue = new ScatterSeriesStatesHoverHalo();
      ...
      this.Marker = this.Marker_DefaultValue = new ScatterSeriesStatesHoverMarker();
    }
