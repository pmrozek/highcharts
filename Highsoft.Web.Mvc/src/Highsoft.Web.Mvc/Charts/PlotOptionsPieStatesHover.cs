...
// Type: Highsoft.Web.Mvc.Charts.PlotOptionsPieStatesHover
...
namespace Highsoft.Web.Mvc.Charts
{
  public class PlotOptionsPieStatesHover : BaseObject
  {
    ...
    public PlotOptionsPieStatesHover()
    {
      ...
      this.Halo = this.Halo_DefaultValue = new PlotOptionsPieStatesHoverHalo();
      ...
      this.Marker = this.Marker_DefaultValue = new PlotOptionsPieStatesHoverMarker();
    }
