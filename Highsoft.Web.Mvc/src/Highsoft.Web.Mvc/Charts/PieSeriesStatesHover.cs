...
// Type: Highsoft.Web.Mvc.Charts.PieSeriesStatesHover
...
namespace Highsoft.Web.Mvc.Charts
{
  public class PieSeriesStatesHover : BaseObject
  {
    ...
    public PieSeriesStatesHover()
    {
      ...
      this.Halo = this.Halo_DefaultValue = new PieSeriesStatesHoverHalo();
      ...
      this.Marker = this.Marker_DefaultValue = new PieSeriesStatesHoverMarker();
    }
