...
// Type: Highsoft.Web.Mvc.Stocks.PlotOptionsPolygonDataGrouping
...
{
  public class PlotOptionsPolygonDataGrouping : BaseObject
  {
    ...
    internal override Hashtable ToHashtable()
    {
      ...
      if (this.Approximation != this.Approximation_DefaultValue)
      {
        ...
        Highstock.AddFunction("PlotOptionsPolygonDataGroupingApproximation.approximation", this.Approximation);
      }
