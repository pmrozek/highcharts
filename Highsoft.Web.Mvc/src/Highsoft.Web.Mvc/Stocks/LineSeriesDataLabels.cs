// Type: Highsoft.Web.Mvc.Stocks.LineSeriesDataLabels
...
namespace Highsoft.Web.Mvc.Stocks
{
    public class LineSeriesDataLabels : BaseObject
    {
        ...
        {
            this.Align = this.Align_DefaultValue = LineSeriesDataLabelsAlign.Center;
            ...
            this.Overflow = this.Overflow_DefaultValue = LineSeriesDataLabelsOverflow.Justify;
            ...
            this.VerticalAlign = this.VerticalAlign_DefaultValue = LineSeriesDataLabelsVerticalAlign.Null;
            nullable2 = new double?(0.0);
        ...
        internal override Hashtable ToHashtable()
        {
            ...
            if (this.Formatter != this.Formatter_DefaultValue)
            {
                ...
                Highstock.AddFunction("LineSeriesDataLabelsFormatter.formatter", this.Formatter);
            }
