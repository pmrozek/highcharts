// Type: Highsoft.Web.Mvc.Stocks.ColumnrangeSeriesDataGrouping
...
{
    public class ColumnrangeSeriesDataGrouping : BaseObject
    {
        ...
        internal override Hashtable ToHashtable()
        {
            ...
            if (this.Approximation != this.Approximation_DefaultValue)
            {
                ...
                Highstock.AddFunction("ColumnrangeSeriesDataGroupingApproximation.approximation", this.Approximation);
            }
