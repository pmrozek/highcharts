// Type: Highsoft.Web.Mvc.Stocks.AreasplinerangeSeriesDataLabels
...
namespace Highsoft.Web.Mvc.Stocks
{
    public class AreasplinerangeSeriesDataLabels : BaseObject
    {
        ...
        {
            this.Align = this.Align_DefaultValue = AreasplinerangeSeriesDataLabelsAlign.Center;
            ...
            this.Overflow = this.Overflow_DefaultValue = AreasplinerangeSeriesDataLabelsOverflow.Justify;
            ...
            this.VerticalAlign = this.VerticalAlign_DefaultValue = AreasplinerangeSeriesDataLabelsVerticalAlign.Null;
            nullable2 = new double?(0.0);
        ...
        internal override Hashtable ToHashtable()
        {
            ...
            if (this.Formatter != this.Formatter_DefaultValue)
            {
                ...
                Highstock.AddFunction("AreasplinerangeSeriesDataLabelsFormatter.formatter", this.Formatter);
            }
