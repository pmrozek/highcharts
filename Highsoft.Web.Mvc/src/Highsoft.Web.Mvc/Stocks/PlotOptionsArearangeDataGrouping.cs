...
// Type: Highsoft.Web.Mvc.Stocks.PlotOptionsArearangeDataGrouping
...
{
  public class PlotOptionsArearangeDataGrouping : BaseObject
  {
    ...
    internal override Hashtable ToHashtable()
    {
      ...
      if (this.Approximation != this.Approximation_DefaultValue)
      {
        ...
        Highstock.AddFunction("PlotOptionsArearangeDataGroupingApproximation.approximation", this.Approximation);
      }
