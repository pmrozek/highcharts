...
// Type: Highsoft.Web.Mvc.Stocks.PolygonSeriesDataGrouping
...
{
  public class PolygonSeriesDataGrouping : BaseObject
  {
    ...
    internal override Hashtable ToHashtable()
    {
      ...
      if (this.Approximation != this.Approximation_DefaultValue)
      {
        ...
        Highstock.AddFunction("PolygonSeriesDataGroupingApproximation.approximation", this.Approximation);
      }
