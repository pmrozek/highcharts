    ...
    private List<Hashtable> SeriesToHashtables(List<Series> listOfSeries)
    {
      ...
      foreach (Series series in listOfSeries)
      {
        ...
        if (series is AreasplinerangeSeries)
        {
          ...
          areasplinerangeSeries.Data.ForEach((Action<AreasplinerangeSeriesData>) (data => dataList.Add((object) data.ToHashtable())));
          int num = 8;
        ...
        if (series is CandleStickSeries)
        {
          ...
          candleStickSeries.Data.ForEach((Action<CandleStickSeriesData>) (data => dataList.Add((object) data.ToHashtable())));
          int num = 23;
        ...
        if (series is FlagsSeries)
        {
          ...
          flagsSeries.Data.ForEach((Action<FlagsSeriesData>) (data => dataList.Add((object) data.ToHashtable())));
          int num = 24;
