// Type: Highsoft.Web.Mvc.Stocks.LineSeriesDataGrouping
...
{
    public class LineSeriesDataGrouping : BaseObject
    {
        ...
        internal override Hashtable ToHashtable()
        {
            ...
            if (this.Approximation != this.Approximation_DefaultValue)
            {
                ...
                Highstock.AddFunction("LineSeriesDataGroupingApproximation.approximation", this.Approximation);
            }
