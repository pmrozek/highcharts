...
// Type: Highsoft.Web.Mvc.Stocks.PlotOptionsColumnStatesHover
...
namespace Highsoft.Web.Mvc.Stocks
{
  public class PlotOptionsColumnStatesHover : BaseObject
  {
    ...
    public PlotOptionsColumnStatesHover()
    {
      ...
      this.Halo = this.Halo_DefaultValue = new PlotOptionsColumnStatesHoverHalo();
      ...
      this.Marker = this.Marker_DefaultValue = new PlotOptionsColumnStatesHoverMarker();
    }
