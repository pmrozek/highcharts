// Type: Highsoft.Web.Mvc.Stocks.AreasplineSeriesDataGrouping
...
{
    public class AreasplineSeriesDataGrouping : BaseObject
    {
        ...
        internal override Hashtable ToHashtable()
        {
            ...
            if (this.Approximation != this.Approximation_DefaultValue)
            {
                ...
                Highstock.AddFunction("AreasplineSeriesDataGroupingApproximation.approximation", this.Approximation);
            }
