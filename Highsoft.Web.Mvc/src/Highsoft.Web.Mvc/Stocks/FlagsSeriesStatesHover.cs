...
// Type: Highsoft.Web.Mvc.Stocks.FlagsSeriesStatesHover
...
{
  public class FlagsSeriesStatesHover : BaseObject
  {
    ...
    public FlagsSeriesStatesHover()
    {
      ...
      this.Halo = this.Halo_DefaultValue = new FlagsSeriesStatesHoverHalo();
      ...
      this.Marker = this.Marker_DefaultValue = new FlagsSeriesStatesHoverMarker();
    }
