...
// Type: Highsoft.Web.Mvc.Stocks.PlotOptionsCandlestickStatesHover
...
{
  public class PlotOptionsCandlestickStatesHover : BaseObject
  {
    ...
    public PlotOptionsCandlestickStatesHover()
    {
      ...
      this.Halo = this.Halo_DefaultValue = new PlotOptionsCandlestickStatesHoverHalo();
      ...
      this.Marker = this.Marker_DefaultValue = new PlotOptionsCandlestickStatesHoverMarker();
    }
