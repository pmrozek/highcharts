...
// Type: Highsoft.Web.Mvc.Stocks.PlotOptionsAreasplinerangeTooltip
  ...
  public class PlotOptionsAreasplinerangeTooltip : BaseObject
  {
    ...
    internal override Hashtable ToHashtable()
    {
      ...
      if (this.PointFormatter != this.PointFormatter_DefaultValue)
      {
        ...
        Highstock.AddFunction("PlotOptionsAreasplinerangeTooltipPointFormatter.pointFormatter", this.PointFormatter);
      }
