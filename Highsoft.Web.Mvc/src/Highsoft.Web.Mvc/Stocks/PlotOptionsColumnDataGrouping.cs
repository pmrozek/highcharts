...
// Type: Highsoft.Web.Mvc.Stocks.PlotOptionsColumnDataGrouping
...
{
  public class PlotOptionsColumnDataGrouping : BaseObject
  {
    ...
    internal override Hashtable ToHashtable()
    {
      ...
      if (this.Approximation != this.Approximation_DefaultValue)
      {
        ...
        Highstock.AddFunction("PlotOptionsColumnDataGroupingApproximation.approximation", this.Approximation);
      }
