...
// Type: Highsoft.Web.Mvc.Stocks.PlotOptionsAreasplinerangeDataGrouping
...
{
  public class PlotOptionsAreasplinerangeDataGrouping : BaseObject
  {
    ...
    internal override Hashtable ToHashtable()
    {
      ...
      if (this.Approximation != this.Approximation_DefaultValue)
      {
        ...
        Highstock.AddFunction("PlotOptionsAreasplinerangeDataGroupingApproximation.approximation", this.Approximation);
      }
