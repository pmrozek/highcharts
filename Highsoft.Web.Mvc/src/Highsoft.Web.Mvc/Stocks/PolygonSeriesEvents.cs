// Type: Highsoft.Web.Mvc.Stocks.PolygonSeriesEvents
    ...
    public class PolygonSeriesEvents : BaseObject
    {
        ...
        internal override Hashtable ToHashtable()
        {
            ...
            if (this.AfterAnimate != this.AfterAnimate_DefaultValue)
            {
                ...
                Highstock.AddFunction("PolygonSeriesEventsAfterAnimate.afterAnimate", this.AfterAnimate);
            }
            if (this.CheckboxClick != this.CheckboxClick_DefaultValue)
            {
                hashtable.Add((object) "checkboxClick", (object) this.CheckboxClick);
                Highstock.AddFunction("PolygonSeriesEventsCheckboxClick.checkboxClick", this.CheckboxClick);
            }
            if (this.Click != this.Click_DefaultValue)
            {
                hashtable.Add((object) "click", (object) this.Click);
                Highstock.AddFunction("PolygonSeriesEventsClick.click", this.Click);
            }
            if (this.Hide != this.Hide_DefaultValue)
            {
                hashtable.Add((object) "hide", (object) this.Hide);
                Highstock.AddFunction("PolygonSeriesEventsHide.hide", this.Hide);
            }
            if (this.LegendItemClick != this.LegendItemClick_DefaultValue)
            {
                ...
                Highstock.AddFunction("PolygonSeriesEventsLegendItemClick.legendItemClick", this.LegendItemClick);
            }
            if (this.MouseOut != this.MouseOut_DefaultValue)
            {
                hashtable.Add((object) "mouseOut", (object) this.MouseOut);
                Highstock.AddFunction("PolygonSeriesEventsMouseOut.mouseOut", this.MouseOut);
            }
            if (this.MouseOver != this.MouseOver_DefaultValue)
            {
                hashtable.Add((object) "mouseOver", (object) this.MouseOver);
                Highstock.AddFunction("PolygonSeriesEventsMouseOver.mouseOver", this.MouseOver);
            }
            if (this.Show != this.Show_DefaultValue)
            {
                hashtable.Add((object) "show", (object) this.Show);
                Highstock.AddFunction("PolygonSeriesEventsShow.show", this.Show);
            }
            return hashtable;
        }
