// Type: Highsoft.Web.Mvc.Stocks.SplineSeriesData
...
namespace Highsoft.Web.Mvc.Stocks
{
    public class SplineSeriesData : BaseObject
    {
        public SplineSeriesData()
        {
            ...
            this.Events = this.Events_DefaultValue = new SplineSeriesDataEvents();
            this.Id = this.Id_DefaultValue = "null";
            double? nullable1 = new double?();
            this.Labelrank_DefaultValue = nullable1;
            this.Labelrank = nullable1;
            this.Marker = this.Marker_DefaultValue = new SplineSeriesDataMarker();
