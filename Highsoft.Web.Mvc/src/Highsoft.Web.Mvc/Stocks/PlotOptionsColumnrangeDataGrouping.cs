...
// Type: Highsoft.Web.Mvc.Stocks.PlotOptionsColumnrangeDataGrouping
...
{
  public class PlotOptionsColumnrangeDataGrouping : BaseObject
  {
    ...
    internal override Hashtable ToHashtable()
    {
      ...
      if (this.Approximation != this.Approximation_DefaultValue)
      {
        ...
        Highstock.AddFunction("PlotOptionsColumnrangeDataGroupingApproximation.approximation", this.Approximation);
      }
