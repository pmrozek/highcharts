// Type: Highsoft.Web.Mvc.Stocks.PlotOptionsSeries
...
namespace Highsoft.Web.Mvc.Stocks
{
    public class PlotOptionsSeries : BaseObject
    {
        public PlotOptionsSeries()
        {
            ...
            this.CompareBase = this.CompareBase_DefaultValue = PlotOptionsSeriesCompareBase.Min;
            ...
            this.DataGrouping = this.DataGrouping_DefaultValue = new PlotOptionsSeriesDataGrouping();
            ...
            this.Step = this.Step_DefaultValue = PlotOptionsSeriesStep.False;
            nullable4 = new bool?(true);
            ...
            this.Zones = this.Zones_DefaultValue = new List<PlotOptionsSeriesZone>();
        }
