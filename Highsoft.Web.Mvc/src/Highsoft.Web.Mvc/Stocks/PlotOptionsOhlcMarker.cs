// Type: Highsoft.Web.Mvc.Stocks.PlotOptionsOhlcMarker
...
{
    public class PlotOptionsOhlcMarker : BaseObject
    {
        ...
        public PlotOptionsOhlcMarker()
        {
            ...
            this.States = this.States_DefaultValue = new PlotOptionsOhlcMarkerStates();
