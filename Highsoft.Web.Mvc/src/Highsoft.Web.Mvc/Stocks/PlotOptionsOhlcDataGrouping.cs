// Type: Highsoft.Web.Mvc.Stocks.PlotOptionsOhlcDataGrouping
...
{
    public class PlotOptionsOhlcDataGrouping : BaseObject
    {
        ...
        internal override Hashtable ToHashtable()
        {
            ...
            if (this.Approximation != this.Approximation_DefaultValue)
            {
                ...
                Highstock.AddFunction("PlotOptionsOhlcDataGroupingApproximation.approximation", this.Approximation);
            }
