// Type: Highsoft.Web.Mvc.Stocks.AreasplineSeriesDataLabels
...
namespace Highsoft.Web.Mvc.Stocks
{
    public class AreasplineSeriesDataLabels : BaseObject
    {
        ...
        {
            this.Align = this.Align_DefaultValue = AreasplineSeriesDataLabelsAlign.Center;
            ...
            this.Overflow = this.Overflow_DefaultValue = AreasplineSeriesDataLabelsOverflow.Justify;
            ...
            this.VerticalAlign = this.VerticalAlign_DefaultValue = AreasplineSeriesDataLabelsVerticalAlign.Null;
            nullable2 = new double?(0.0);
        ...
        internal override Hashtable ToHashtable()
        {
            ...
            if (this.Formatter != this.Formatter_DefaultValue)
            {
                ...
                Highstock.AddFunction("AreasplineSeriesDataLabelsFormatter.formatter", this.Formatter);
            }
