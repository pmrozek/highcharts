// Type: Highsoft.Web.Mvc.Stocks.PlotOptionsLineDataGrouping
...
{
    public class PlotOptionsLineDataGrouping : BaseObject
    {
        ...
        internal override Hashtable ToHashtable()
        {
            ...
            if (this.Approximation != this.Approximation_DefaultValue)
            {
                ...
                Highstock.AddFunction("PlotOptionsLineDataGroupingApproximation.approximation", this.Approximation);
            }
