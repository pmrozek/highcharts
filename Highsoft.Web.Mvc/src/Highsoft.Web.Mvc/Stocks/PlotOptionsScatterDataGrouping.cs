// Type: Highsoft.Web.Mvc.Stocks.PlotOptionsScatterDataGrouping
...
{
    public class PlotOptionsScatterDataGrouping : BaseObject
    {
        ...
        internal override Hashtable ToHashtable()
        {
            ...
            if (this.Approximation != this.Approximation_DefaultValue)
            {
                ...
                Highstock.AddFunction("PlotOptionsScatterDataGroupingApproximation.approximation", this.Approximation);
            }
