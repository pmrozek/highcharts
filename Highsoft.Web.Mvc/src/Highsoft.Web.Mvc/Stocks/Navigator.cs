...
namespace Highsoft.Web.Mvc.Stocks
{
  public class Navigator : BaseObject
  {
    ...
    public Navigator()
    {
      ...
      this.Handles = this.Handles_DefaultValue = (object) null;
      ...
      this.MaskFill = this.MaskFill_DefaultValue = "rgba(128,179,236,0.3)";
      nullable1 = new bool?(true);
      this.MaskInside_DefaultValue = nullable1;
      this.MaskInside = nullable1;
      this.OutlineColor = this.OutlineColor_DefaultValue = "#b2b1b6";
    ...
    internal override Hashtable ToHashtable()
    {
      ...
      if ((adaptToUpdatedData.GetValueOrDefault() == dataDefaultValue.GetValueOrDefault() ? (adaptToUpdatedData.HasValue != dataDefaultValue.HasValue ? 1 : 0) : 1) != 0)
      ...
      if (this.Handles != this.Handles_DefaultValue)
        hashtable.Add((object) "handles", this.Handles);
      double? height = this.Height;
      double? nullable2 = this.Height_DefaultValue;
      if ((height.GetValueOrDefault() == nullable2.GetValueOrDefault() ? (height.HasValue != nullable2.HasValue ? 1 : 0) : 1) != 0)
      ...
      if ((nullable1.GetValueOrDefault() == insideDefaultValue.GetValueOrDefault() ? (nullable1.HasValue != insideDefaultValue.HasValue ? 1 : 0) : 1) != 0)
      ...
      if ((nullable2.GetValueOrDefault() == widthDefaultValue.GetValueOrDefault() ? (nullable2.HasValue != widthDefaultValue.HasValue ? 1 : 0) : 1) != 0)
