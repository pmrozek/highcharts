...
// Type: Highsoft.Web.Mvc.Stocks.PlotOptionsArearangeTooltip
  ...
  public class PlotOptionsArearangeTooltip : BaseObject
  {
    ...
    internal override Hashtable ToHashtable()
    {
      ...
      if (this.PointFormatter != this.PointFormatter_DefaultValue)
      {
        ...
        Highstock.AddFunction("PlotOptionsArearangeTooltipPointFormatter.pointFormatter", this.PointFormatter);
      }
