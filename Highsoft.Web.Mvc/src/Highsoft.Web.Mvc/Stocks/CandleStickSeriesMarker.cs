// Type: Highsoft.Web.Mvc.Stocks.CandleStickSeriesMarker
...
{
    public class CandleStickSeriesMarker : BaseObject
    {
        ...
        public CandleStickSeriesMarker()
        {
            ...
            this.States = this.States_DefaultValue = new CandleStickSeriesMarkerStates();
