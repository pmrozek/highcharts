// Type: Highsoft.Web.Mvc.Stocks.ColumnrangeSeriesMarker
...
{
    public class ColumnrangeSeriesMarker : BaseObject
    {
        ...
        public ColumnrangeSeriesMarker()
        {
            ...
            this.States = this.States_DefaultValue = new ColumnrangeSeriesMarkerStates();
