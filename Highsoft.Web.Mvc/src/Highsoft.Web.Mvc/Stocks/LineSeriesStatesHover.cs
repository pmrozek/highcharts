...
// Type: Highsoft.Web.Mvc.Stocks.LineSeriesStatesHover
...
namespace Highsoft.Web.Mvc.Stocks
{
  public class LineSeriesStatesHover : BaseObject
  {
    ...
    public LineSeriesStatesHover()
    {
      ...
      this.Halo = this.Halo_DefaultValue = new LineSeriesStatesHoverHalo();
      ...
      this.Marker = this.Marker_DefaultValue = new LineSeriesStatesHoverMarker();
    }
