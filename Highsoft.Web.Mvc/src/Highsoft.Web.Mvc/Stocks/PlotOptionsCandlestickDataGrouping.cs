...
// Type: Highsoft.Web.Mvc.Stocks.PlotOptionsCandlestickDataGrouping
...
{
  public class PlotOptionsCandlestickDataGrouping : BaseObject
  {
    ...
    internal override Hashtable ToHashtable()
    {
      ...
      if (this.Approximation != this.Approximation_DefaultValue)
      {
        ...
        Highstock.AddFunction("PlotOptionsCandlestickDataGroupingApproximation.approximation", this.Approximation);
      }
