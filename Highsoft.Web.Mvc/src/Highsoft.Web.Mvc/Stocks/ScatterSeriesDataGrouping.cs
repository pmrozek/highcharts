...
// Type: Highsoft.Web.Mvc.Stocks.ScatterSeriesDataGrouping
...
{
  public class ScatterSeriesDataGrouping : BaseObject
  {
    ...
    internal override Hashtable ToHashtable()
    {
      ...
      if (this.Approximation != this.Approximation_DefaultValue)
      {
        ...
        Highstock.AddFunction("ScatterSeriesDataGroupingApproximation.approximation", this.Approximation);
      }
