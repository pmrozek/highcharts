...
// Type: Highsoft.Web.Mvc.Stocks.PlotOptionsAreasplinerangeDataLabels
...
namespace Highsoft.Web.Mvc.Stocks
{
  public class PlotOptionsAreasplinerangeDataLabels : BaseObject
  {
    ...
    {
      this.Align = this.Align_DefaultValue = PlotOptionsAreasplinerangeDataLabelsAlign.Center;
      ...
      this.Overflow = this.Overflow_DefaultValue = PlotOptionsAreasplinerangeDataLabelsOverflow.Justify;
      ...
      this.VerticalAlign = this.VerticalAlign_DefaultValue = PlotOptionsAreasplinerangeDataLabelsVerticalAlign.Null;
      nullable2 = new double?(0.0);
    ...
    internal override Hashtable ToHashtable()
    {
      ...
      if (this.Formatter != this.Formatter_DefaultValue)
      {
        ...
        Highstock.AddFunction("PlotOptionsAreasplinerangeDataLabelsFormatter.formatter", this.Formatter);
      }
