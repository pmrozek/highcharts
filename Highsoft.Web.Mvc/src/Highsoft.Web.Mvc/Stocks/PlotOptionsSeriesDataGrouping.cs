...
// Type: Highsoft.Web.Mvc.Stocks.PlotOptionsSeriesDataGrouping
...
{
  public class PlotOptionsSeriesDataGrouping : BaseObject
  {
    ...
    internal override Hashtable ToHashtable()
    {
      ...
      if (this.Approximation != this.Approximation_DefaultValue)
      {
        ...
        Highstock.AddFunction("PlotOptionsSeriesDataGroupingApproximation.approximation", this.Approximation);
      }
