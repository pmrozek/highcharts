// Type: Highsoft.Web.Mvc.Stocks.AreaSeriesDataLabels
...
namespace Highsoft.Web.Mvc.Stocks
{
    public class AreaSeriesDataLabels : BaseObject
    {
        ...
        {
            this.Align = this.Align_DefaultValue = AreaSeriesDataLabelsAlign.Center;
            ...
            this.Overflow = this.Overflow_DefaultValue = AreaSeriesDataLabelsOverflow.Justify;
            ...
            this.VerticalAlign = this.VerticalAlign_DefaultValue = AreaSeriesDataLabelsVerticalAlign.Null;
            nullable2 = new double?(0.0);
        ...
        internal override Hashtable ToHashtable()
        {
            ...
            if (this.Formatter != this.Formatter_DefaultValue)
            {
                ...
                Highstock.AddFunction("AreaSeriesDataLabelsFormatter.formatter", this.Formatter);
            }
