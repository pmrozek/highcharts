// Type: Highsoft.Web.Mvc.Stocks.PlotOptionsAreasplineDataLabels
...
namespace Highsoft.Web.Mvc.Stocks
{
    public class PlotOptionsAreasplineDataLabels : BaseObject
    {
        ...
        {
            this.Align = this.Align_DefaultValue = PlotOptionsAreasplineDataLabelsAlign.Center;
            ...
            this.Overflow = this.Overflow_DefaultValue = PlotOptionsAreasplineDataLabelsOverflow.Justify;
            ...
            this.VerticalAlign = this.VerticalAlign_DefaultValue = PlotOptionsAreasplineDataLabelsVerticalAlign.Null;
            nullable2 = new double?(0.0);
        ...
        internal override Hashtable ToHashtable()
        {
            ...
            if (this.Formatter != this.Formatter_DefaultValue)
            {
                ...
                Highstock.AddFunction("PlotOptionsAreasplineDataLabelsFormatter.formatter", this.Formatter);
            }
