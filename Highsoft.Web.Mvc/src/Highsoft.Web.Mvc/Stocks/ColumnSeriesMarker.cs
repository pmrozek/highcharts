// Type: Highsoft.Web.Mvc.Stocks.ColumnSeriesMarker
...
{
    public class ColumnSeriesMarker : BaseObject
    {
        ...
        public ColumnSeriesMarker()
        {
            ...
            this.States = this.States_DefaultValue = new ColumnSeriesMarkerStates();
