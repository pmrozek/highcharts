// Type: Highsoft.Web.Mvc.Stocks.OhlcSeriesDataLabels
...
{
    public class OhlcSeriesDataLabels : BaseObject
    {
        public OhlcSeriesDataLabels()
        {
            this.Align = this.Align_DefaultValue = OhlcSeriesDataLabelsAlign.Center;
            ...
            this.Overflow = this.Overflow_DefaultValue = OhlcSeriesDataLabelsOverflow.Justify;
            ...
            this.VerticalAlign = this.VerticalAlign_DefaultValue = OhlcSeriesDataLabelsVerticalAlign.Null;
            nullable2 = new double?(0.0);
        ...
        internal override Hashtable ToHashtable()
        {
            ...
            if (this.Formatter != this.Formatter_DefaultValue)
            {
                ...
                Highstock.AddFunction("OhlcSeriesDataLabelsFormatter.formatter", this.Formatter);
            }
