// Type: Highsoft.Web.Mvc.Stocks.OhlcSeries
...
namespace Highsoft.Web.Mvc.Stocks
{
    public class OhlcSeries : Series
    {
        ...
        public OhlcSeries()
        {
            ...
            this.Cursor = this.Cursor_DefaultValue = OhlcSeriesCursor.Null;
            this.Data = this.Data_DefaultValue = new List<OhlcSeriesData>();
            this.DataGrouping = this.DataGrouping_DefaultValue = new OhlcSeriesDataGrouping();
            this.DataLabels = this.DataLabels_DefaultValue = new OhlcSeriesDataLabels();
            this.Description = this.Description_DefaultValue = "undefined";
            nullable1 = new bool?(true);
            this.EnableMouseTracking_DefaultValue = nullable1;
            this.EnableMouseTracking = nullable1;
            this.Events = this.Events_DefaultValue = new OhlcSeriesEvents();
            nullable1 = new bool?(false);
            ...
            this.Point = this.Point_DefaultValue = new OhlcSeriesPoint();
            nullable5 = new double?(1.0);
            this.PointInterval_DefaultValue = nullable5;
            this.PointInterval = nullable5;
            this.PointIntervalUnit = this.PointIntervalUnit_DefaultValue = OhlcSeriesPointIntervalUnit.Null;
            ...
            nullable8 = new bool?(false);
            this.SoftThreshold_DefaultValue = nullable8;
            this.SoftThreshold = nullable8;
            this.Stack = this.Stack_DefaultValue = "null";
            this.States = this.States_DefaultValue = new OhlcSeriesStates();
            ...
            this.Tooltip = this.Tooltip_DefaultValue = new OhlcSeriesTooltip();
            nullable7 = new double?(1000.0);
            this.TurboThreshold_DefaultValue = nullable7;
            this.TurboThreshold = nullable7;
            this.Type = this.Type_DefaultValue = OhlcSeriesType.Null;
            ...
            this.Zones = this.Zones_DefaultValue = new OhlcSeriesZones();
        }
