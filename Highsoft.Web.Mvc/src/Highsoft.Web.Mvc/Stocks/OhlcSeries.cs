...
namespace Highsoft.Web.Mvc.Stocks
{
    public class OhlcSeries : Series
    {
        public OhlcSeries()
        {
            ...
            this.CompareBase = this.CompareBase_DefaultValue = OhlcSeriesCompareBase.Min;
            ...
            this.Zones = this.Zones_DefaultValue = new List<OhlcSeriesZone>();
        }
        ...
        internal override Hashtable ToHashtable()
        {
            ...
            if (this.Data.Any<OhlcSeriesData>())
