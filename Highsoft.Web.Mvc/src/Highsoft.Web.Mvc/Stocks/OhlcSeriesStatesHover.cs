...
// Type: Highsoft.Web.Mvc.Stocks.OhlcSeriesStatesHover
...
{
  public class OhlcSeriesStatesHover : BaseObject
  {
    ...
    public OhlcSeriesStatesHover()
    {
      ...
      this.Halo = this.Halo_DefaultValue = new OhlcSeriesStatesHoverHalo();
      ...
      this.Marker = this.Marker_DefaultValue = new OhlcSeriesStatesHoverMarker();
    }
