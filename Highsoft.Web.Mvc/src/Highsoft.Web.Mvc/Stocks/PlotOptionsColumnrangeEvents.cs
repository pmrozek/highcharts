...
// Type: Highsoft.Web.Mvc.Stocks.PlotOptionsColumnrangeEvents
  ...
  public class PlotOptionsColumnrangeEvents : BaseObject
  {
    ...
    internal override Hashtable ToHashtable()
    {
      ...
      if (this.AfterAnimate != this.AfterAnimate_DefaultValue)
      {
        ...
        Highstock.AddFunction("PlotOptionsColumnrangeEventsAfterAnimate.afterAnimate", this.AfterAnimate);
      }
      if (this.CheckboxClick != this.CheckboxClick_DefaultValue)
      {
        hashtable.Add((object) "checkboxClick", (object) this.CheckboxClick);
        Highstock.AddFunction("PlotOptionsColumnrangeEventsCheckboxClick.checkboxClick", this.CheckboxClick);
      }
      if (this.Click != this.Click_DefaultValue)
      {
        hashtable.Add((object) "click", (object) this.Click);
        Highstock.AddFunction("PlotOptionsColumnrangeEventsClick.click", this.Click);
      }
      if (this.Hide != this.Hide_DefaultValue)
      {
        hashtable.Add((object) "hide", (object) this.Hide);
        Highstock.AddFunction("PlotOptionsColumnrangeEventsHide.hide", this.Hide);
      }
      if (this.LegendItemClick != this.LegendItemClick_DefaultValue)
      {
        ...
        Highstock.AddFunction("PlotOptionsColumnrangeEventsLegendItemClick.legendItemClick", this.LegendItemClick);
      }
      if (this.MouseOut != this.MouseOut_DefaultValue)
      {
        hashtable.Add((object) "mouseOut", (object) this.MouseOut);
        Highstock.AddFunction("PlotOptionsColumnrangeEventsMouseOut.mouseOut", this.MouseOut);
      }
      if (this.MouseOver != this.MouseOver_DefaultValue)
      {
        hashtable.Add((object) "mouseOver", (object) this.MouseOver);
        Highstock.AddFunction("PlotOptionsColumnrangeEventsMouseOver.mouseOver", this.MouseOver);
      }
      if (this.Show != this.Show_DefaultValue)
      {
        hashtable.Add((object) "show", (object) this.Show);
        Highstock.AddFunction("PlotOptionsColumnrangeEventsShow.show", this.Show);
      }
      return hashtable;
    }
