...
// Type: Highsoft.Web.Mvc.Stocks.SplineSeriesDataGrouping
...
{
  public class SplineSeriesDataGrouping : BaseObject
  {
    ...
    internal override Hashtable ToHashtable()
    {
      ...
      if (this.Approximation != this.Approximation_DefaultValue)
      {
        ...
        Highstock.AddFunction("SplineSeriesDataGroupingApproximation.approximation", this.Approximation);
      }
