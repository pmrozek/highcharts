...
// Type: Highsoft.Web.Mvc.Stocks.PlotOptionsLineStatesHover
...
namespace Highsoft.Web.Mvc.Stocks
{
  public class PlotOptionsLineStatesHover : BaseObject
  {
    ...
    public PlotOptionsLineStatesHover()
    {
      ...
      this.Halo = this.Halo_DefaultValue = new PlotOptionsLineStatesHoverHalo();
      ...
      this.Marker = this.Marker_DefaultValue = new PlotOptionsLineStatesHoverMarker();
    }
