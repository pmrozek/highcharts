// Type: Highsoft.Web.Mvc.Stocks.PlotOptionsSplineDataLabels
...
namespace Highsoft.Web.Mvc.Stocks
{
    public class PlotOptionsSplineDataLabels : BaseObject
    {
        ...
        {
            this.Align = this.Align_DefaultValue = PlotOptionsSplineDataLabelsAlign.Center;
            ...
            this.Overflow = this.Overflow_DefaultValue = PlotOptionsSplineDataLabelsOverflow.Justify;
            ...
            this.VerticalAlign = this.VerticalAlign_DefaultValue = PlotOptionsSplineDataLabelsVerticalAlign.Null;
            nullable2 = new double?(0.0);
        ...
        internal override Hashtable ToHashtable()
        {
            ...
            if (this.Formatter != this.Formatter_DefaultValue)
            {
                ...
                Highstock.AddFunction("PlotOptionsSplineDataLabelsFormatter.formatter", this.Formatter);
            }
