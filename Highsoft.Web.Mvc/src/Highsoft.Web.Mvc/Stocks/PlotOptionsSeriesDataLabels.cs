...
// Type: Highsoft.Web.Mvc.Stocks.PlotOptionsSeriesDataLabels
...
namespace Highsoft.Web.Mvc.Stocks
{
  public class PlotOptionsSeriesDataLabels : BaseObject
  {
    ...
    {
      this.Align = this.Align_DefaultValue = PlotOptionsSeriesDataLabelsAlign.Center;
      ...
      this.Overflow = this.Overflow_DefaultValue = PlotOptionsSeriesDataLabelsOverflow.Justify;
      ...
      this.VerticalAlign = this.VerticalAlign_DefaultValue = PlotOptionsSeriesDataLabelsVerticalAlign.Null;
      nullable2 = new double?(0.0);
    ...
    internal override Hashtable ToHashtable()
    {
      ...
      if (this.Formatter != this.Formatter_DefaultValue)
      {
        ...
        Highstock.AddFunction("PlotOptionsSeriesDataLabelsFormatter.formatter", this.Formatter);
      }
