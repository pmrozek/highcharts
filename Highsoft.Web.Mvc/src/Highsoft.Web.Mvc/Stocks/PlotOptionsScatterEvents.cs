// Type: Highsoft.Web.Mvc.Stocks.PlotOptionsScatterEvents
    ...
    public class PlotOptionsScatterEvents : BaseObject
    {
        ...
        internal override Hashtable ToHashtable()
        {
            ...
            if (this.AfterAnimate != this.AfterAnimate_DefaultValue)
            {
                ...
                Highstock.AddFunction("PlotOptionsScatterEventsAfterAnimate.afterAnimate", this.AfterAnimate);
            }
            if (this.CheckboxClick != this.CheckboxClick_DefaultValue)
            {
                hashtable.Add((object) "checkboxClick", (object) this.CheckboxClick);
                Highstock.AddFunction("PlotOptionsScatterEventsCheckboxClick.checkboxClick", this.CheckboxClick);
            }
            if (this.Click != this.Click_DefaultValue)
            {
                hashtable.Add((object) "click", (object) this.Click);
                Highstock.AddFunction("PlotOptionsScatterEventsClick.click", this.Click);
            }
            if (this.Hide != this.Hide_DefaultValue)
            {
                hashtable.Add((object) "hide", (object) this.Hide);
                Highstock.AddFunction("PlotOptionsScatterEventsHide.hide", this.Hide);
            }
            if (this.LegendItemClick != this.LegendItemClick_DefaultValue)
            {
                ...
                Highstock.AddFunction("PlotOptionsScatterEventsLegendItemClick.legendItemClick", this.LegendItemClick);
            }
            if (this.MouseOut != this.MouseOut_DefaultValue)
            {
                hashtable.Add((object) "mouseOut", (object) this.MouseOut);
                Highstock.AddFunction("PlotOptionsScatterEventsMouseOut.mouseOut", this.MouseOut);
            }
            if (this.MouseOver != this.MouseOver_DefaultValue)
            {
                hashtable.Add((object) "mouseOver", (object) this.MouseOver);
                Highstock.AddFunction("PlotOptionsScatterEventsMouseOver.mouseOver", this.MouseOver);
            }
            if (this.Show != this.Show_DefaultValue)
            {
                hashtable.Add((object) "show", (object) this.Show);
                Highstock.AddFunction("PlotOptionsScatterEventsShow.show", this.Show);
            }
            return hashtable;
        }
