...
// Type: Highsoft.Web.Mvc.Stocks.PlotOptionsOhlcStatesHover
...
{
  public class PlotOptionsOhlcStatesHover : BaseObject
  {
    ...
    public PlotOptionsOhlcStatesHover()
    {
      ...
      this.Halo = this.Halo_DefaultValue = new PlotOptionsOhlcStatesHoverHalo();
      ...
      this.Marker = this.Marker_DefaultValue = new PlotOptionsOhlcStatesHoverMarker();
    }
