...
// Type: Highsoft.Web.Mvc.Stocks.PlotOptionsSeriesStatesHover
...
namespace Highsoft.Web.Mvc.Stocks
{
  public class PlotOptionsSeriesStatesHover : BaseObject
  {
    ...
    public PlotOptionsSeriesStatesHover()
    {
      ...
      this.Halo = this.Halo_DefaultValue = new PlotOptionsSeriesStatesHoverHalo();
      ...
      this.Marker = this.Marker_DefaultValue = new PlotOptionsSeriesStatesHoverMarker();
    }
