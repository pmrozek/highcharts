...
// Type: Highsoft.Web.Mvc.Stocks.AreaSeriesDataGrouping
...
{
  public class AreaSeriesDataGrouping : BaseObject
  {
    ...
    internal override Hashtable ToHashtable()
    {
      ...
      if (this.Approximation != this.Approximation_DefaultValue)
      {
        ...
        Highstock.AddFunction("AreaSeriesDataGroupingApproximation.approximation", this.Approximation);
      }
