...
// Type: Highsoft.Web.Mvc.Stocks.PlotOptionsLineDataLabels
...
namespace Highsoft.Web.Mvc.Stocks
{
  public class PlotOptionsLineDataLabels : BaseObject
  {
    ...
    {
      this.Align = this.Align_DefaultValue = PlotOptionsLineDataLabelsAlign.Center;
      ...
      this.Overflow = this.Overflow_DefaultValue = PlotOptionsLineDataLabelsOverflow.Justify;
      ...
      this.VerticalAlign = this.VerticalAlign_DefaultValue = PlotOptionsLineDataLabelsVerticalAlign.Null;
      nullable2 = new double?(0.0);
    ...
    internal override Hashtable ToHashtable()
    {
      ...
      if (this.Formatter != this.Formatter_DefaultValue)
      {
        ...
        Highstock.AddFunction("PlotOptionsLineDataLabelsFormatter.formatter", this.Formatter);
      }
