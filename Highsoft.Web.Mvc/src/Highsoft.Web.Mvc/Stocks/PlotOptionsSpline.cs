...
namespace Highsoft.Web.Mvc.Stocks
{
    public class PlotOptionsSpline : BaseObject
    {
        public PlotOptionsSpline()
        {
            ...
            this.CompareBase = this.CompareBase_DefaultValue = PlotOptionsSplineCompareBase.Min;
            ...
            this.Linecap = this.Linecap_DefaultValue = PlotOptionsSplineLinecap.Round;
            ...
            this.Zones = this.Zones_DefaultValue = new List<PlotOptionsSplineZone>();
        }
