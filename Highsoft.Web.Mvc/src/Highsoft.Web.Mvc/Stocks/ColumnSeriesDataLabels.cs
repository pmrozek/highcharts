...
// Type: Highsoft.Web.Mvc.Stocks.ColumnSeriesDataLabels
...
namespace Highsoft.Web.Mvc.Stocks
{
  public class ColumnSeriesDataLabels : BaseObject
  {
    ...
    {
      this.Align = this.Align_DefaultValue = ColumnSeriesDataLabelsAlign.Center;
      ...
      this.Overflow = this.Overflow_DefaultValue = ColumnSeriesDataLabelsOverflow.Justify;
      ...
      this.VerticalAlign = this.VerticalAlign_DefaultValue = ColumnSeriesDataLabelsVerticalAlign.Null;
      nullable2 = new double?(0.0);
    ...
    internal override Hashtable ToHashtable()
    {
      ...
      if (this.Formatter != this.Formatter_DefaultValue)
      {
        ...
        Highstock.AddFunction("ColumnSeriesDataLabelsFormatter.formatter", this.Formatter);
      }
