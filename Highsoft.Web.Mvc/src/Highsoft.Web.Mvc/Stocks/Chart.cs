...
namespace Highsoft.Web.Mvc.Stocks
{
  public class Chart : BaseObject
  {
    ...
    public Chart()
    {
      ...
      this.SelectionMarkerFill = this.SelectionMarkerFill_DefaultValue = "rgba(69114,167,0.25),";
    ...
    internal override Hashtable ToHashtable()
    {
      ...
      nullable3 = this.Panning;
      bool? nullable4 = this.Panning_DefaultValue;
      ...
      if (this.PinchType != this.PinchType_DefaultValue)
        hashtable.Add((object) "pinchType", (object) Highstock.FirstCharacterToLower(this.PinchType.ToString()));
