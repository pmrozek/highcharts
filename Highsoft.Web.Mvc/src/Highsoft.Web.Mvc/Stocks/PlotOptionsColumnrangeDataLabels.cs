// Type: Highsoft.Web.Mvc.Stocks.PlotOptionsColumnrangeDataLabels
...
namespace Highsoft.Web.Mvc.Stocks
{
    public class PlotOptionsColumnrangeDataLabels : BaseObject
    {
        ...
        {
            this.Align = this.Align_DefaultValue = PlotOptionsColumnrangeDataLabelsAlign.Center;
            ...
            this.Overflow = this.Overflow_DefaultValue = PlotOptionsColumnrangeDataLabelsOverflow.Justify;
            ...
            this.VerticalAlign = this.VerticalAlign_DefaultValue = PlotOptionsColumnrangeDataLabelsVerticalAlign.Null;
            nullable2 = new double?(0.0);
        ...
        internal override Hashtable ToHashtable()
        {
            ...
            if (this.Formatter != this.Formatter_DefaultValue)
            {
                ...
                Highstock.AddFunction("PlotOptionsColumnrangeDataLabelsFormatter.formatter", this.Formatter);
            }
