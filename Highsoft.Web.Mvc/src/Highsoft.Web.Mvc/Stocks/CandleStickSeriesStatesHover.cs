...
// Type: Highsoft.Web.Mvc.Stocks.CandleStickSeriesStatesHover
...
{
  public class CandleStickSeriesStatesHover : BaseObject
  {
    ...
    public CandleStickSeriesStatesHover()
    {
      ...
      this.Halo = this.Halo_DefaultValue = new CandleStickSeriesStatesHoverHalo();
      ...
      this.Marker = this.Marker_DefaultValue = new CandleStickSeriesStatesHoverMarker();
    }
