// Type: Highsoft.Web.Mvc.Stocks.FlagsSeriesDataLabels
...
{
    public class FlagsSeriesDataLabels : BaseObject
    {
        ...
        {
            this.Align = this.Align_DefaultValue = FlagsSeriesDataLabelsAlign.Center;
            ...
            this.Overflow = this.Overflow_DefaultValue = FlagsSeriesDataLabelsOverflow.Justify;
            ...
            this.VerticalAlign = this.VerticalAlign_DefaultValue = FlagsSeriesDataLabelsVerticalAlign.Null;
            nullable2 = new double?(0.0);
        ...
        internal override Hashtable ToHashtable()
        {
            ...
            if (this.Formatter != this.Formatter_DefaultValue)
            {
                ...
                Highstock.AddFunction("FlagsSeriesDataLabelsFormatter.formatter", this.Formatter);
            }
