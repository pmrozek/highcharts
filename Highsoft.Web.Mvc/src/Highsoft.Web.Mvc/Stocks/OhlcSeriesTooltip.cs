// Type: Highsoft.Web.Mvc.Stocks.OhlcSeriesTooltip
...
{
    public class OhlcSeriesTooltip : BaseObject
    {
        ...
        internal override Hashtable ToHashtable()
        {
            ...
            if (this.PointFormatter != this.PointFormatter_DefaultValue)
            {
                ...
                Highstock.AddFunction("OhlcSeriesTooltipPointFormatter.pointFormatter", this.PointFormatter);
            }
