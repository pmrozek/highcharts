...
namespace Highsoft.Web.Mvc.Stocks
{
    public class ArearangeSeries : Series
    {
        public ArearangeSeries()
        {
            ...
            this.CompareBase = this.CompareBase_DefaultValue = ArearangeSeriesCompareBase.Min;
            ...
            this.Linecap = this.Linecap_DefaultValue = ArearangeSeriesLinecap.Round;
            ...
            this.Step = this.Step_DefaultValue = ArearangeSeriesStep.False;
            ...
            nullable6 = new bool?(true);
            this.TrackByArea_DefaultValue = nullable6;
            this.TrackByArea = nullable6;
            ...
            this.Zones = this.Zones_DefaultValue = new List<ArearangeSeriesZone>();
        }
        ...
        internal override Hashtable ToHashtable()
        {
            ...
            if (this.Data.Any<ArearangeSeriesData>())
