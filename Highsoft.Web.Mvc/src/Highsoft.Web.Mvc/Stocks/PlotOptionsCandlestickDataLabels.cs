// Type: Highsoft.Web.Mvc.Stocks.PlotOptionsCandlestickDataLabels
...
{
    public class PlotOptionsCandlestickDataLabels : BaseObject
    {
        ...
        {
            this.Align = this.Align_DefaultValue = PlotOptionsCandlestickDataLabelsAlign.Center;
            ...
            this.Overflow = this.Overflow_DefaultValue = PlotOptionsCandlestickDataLabelsOverflow.Justify;
            ...
            this.VerticalAlign = this.VerticalAlign_DefaultValue = PlotOptionsCandlestickDataLabelsVerticalAlign.Null;
            nullable2 = new double?(0.0);
        ...
        internal override Hashtable ToHashtable()
        {
            ...
            if (this.Formatter != this.Formatter_DefaultValue)
            {
                ...
                Highstock.AddFunction("PlotOptionsCandlestickDataLabelsFormatter.formatter", this.Formatter);
            }
