...
// Type: Highsoft.Web.Mvc.Stocks.PlotOptionsFlagsStatesHover
...
{
  public class PlotOptionsFlagsStatesHover : BaseObject
  {
    ...
    public PlotOptionsFlagsStatesHover()
    {
      ...
      this.Halo = this.Halo_DefaultValue = new PlotOptionsFlagsStatesHoverHalo();
      ...
      this.Marker = this.Marker_DefaultValue = new PlotOptionsFlagsStatesHoverMarker();
    }
