// Type: Highsoft.Web.Mvc.Stocks.PlotOptionsSplineDataGrouping
...
{
    public class PlotOptionsSplineDataGrouping : BaseObject
    {
        ...
        internal override Hashtable ToHashtable()
        {
            ...
            if (this.Approximation != this.Approximation_DefaultValue)
            {
                ...
                Highstock.AddFunction("PlotOptionsSplineDataGroupingApproximation.approximation", this.Approximation);
            }
