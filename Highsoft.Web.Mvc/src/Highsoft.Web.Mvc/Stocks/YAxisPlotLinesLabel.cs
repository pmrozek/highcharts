...
// Type: Highsoft.Web.Mvc.Stocks.YAxisPlotLinesLabel
...
namespace Highsoft.Web.Mvc.Stocks
{
  public class YAxisPlotLinesLabel : BaseObject
  {
    ...
    internal override Hashtable ToHashtable()
    {
      ...
      if ((rotation.GetValueOrDefault() == nullable1.GetValueOrDefault() ? (rotation.HasValue != nullable1.HasValue ? 1 : 0) : 1) != 0)
      ...
      if ((useHtml.GetValueOrDefault() == htmlDefaultValue.GetValueOrDefault() ? (useHtml.HasValue != htmlDefaultValue.HasValue ? 1 : 0) : 1) != 0)
      ...
      if (this.Text != this.TextAlign_DefaultValue)
