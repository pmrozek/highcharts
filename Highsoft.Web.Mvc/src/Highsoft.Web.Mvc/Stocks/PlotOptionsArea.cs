// Type: Highsoft.Web.Mvc.Stocks.PlotOptionsArea
...
namespace Highsoft.Web.Mvc.Stocks
{
    public class PlotOptionsArea : BaseObject
    {
        public PlotOptionsArea()
        {
            ...
            this.CompareBase = this.CompareBase_DefaultValue = PlotOptionsAreaCompareBase.Min;
            ...
            this.DataGrouping = this.DataGrouping_DefaultValue = new PlotOptionsAreaDataGrouping();
            ...
            this.Zones = this.Zones_DefaultValue = new List<PlotOptionsAreaZone>();
        }
