// Type: Highsoft.Web.Mvc.Stocks.AreasplinerangeSeriesDataGrouping
...
{
    public class AreasplinerangeSeriesDataGrouping : BaseObject
    {
        ...
        internal override Hashtable ToHashtable()
        {
            ...
            if (this.Approximation != this.Approximation_DefaultValue)
            {
                ...
                Highstock.AddFunction("AreasplinerangeSeriesDataGroupingApproximation.approximation", this.Approximation);
            }
