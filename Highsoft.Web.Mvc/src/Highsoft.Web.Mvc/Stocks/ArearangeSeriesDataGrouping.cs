// Type: Highsoft.Web.Mvc.Stocks.ArearangeSeriesDataGrouping
...
{
    public class ArearangeSeriesDataGrouping : BaseObject
    {
        ...
        internal override Hashtable ToHashtable()
        {
            ...
            if (this.Approximation != this.Approximation_DefaultValue)
            {
                ...
                Highstock.AddFunction("ArearangeSeriesDataGroupingApproximation.approximation", this.Approximation);
            }
