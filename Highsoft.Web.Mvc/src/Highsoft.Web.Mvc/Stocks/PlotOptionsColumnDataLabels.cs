// Type: Highsoft.Web.Mvc.Stocks.PlotOptionsColumnDataLabels
...
namespace Highsoft.Web.Mvc.Stocks
{
    public class PlotOptionsColumnDataLabels : BaseObject
    {
        ...
        {
            this.Align = this.Align_DefaultValue = PlotOptionsColumnDataLabelsAlign.Center;
            ...
            this.Overflow = this.Overflow_DefaultValue = PlotOptionsColumnDataLabelsOverflow.Justify;
            ...
            this.VerticalAlign = this.VerticalAlign_DefaultValue = PlotOptionsColumnDataLabelsVerticalAlign.Null;
            nullable2 = new double?(0.0);
        ...
        internal override Hashtable ToHashtable()
        {
            ...
            if (this.Formatter != this.Formatter_DefaultValue)
            {
                ...
                Highstock.AddFunction("PlotOptionsColumnDataLabelsFormatter.formatter", this.Formatter);
            }
