// Type: Highsoft.Web.Mvc.Stocks.SplineSeriesDataLabels
...
namespace Highsoft.Web.Mvc.Stocks
{
    public class SplineSeriesDataLabels : BaseObject
    {
        ...
        {
            this.Align = this.Align_DefaultValue = SplineSeriesDataLabelsAlign.Center;
            ...
            this.Overflow = this.Overflow_DefaultValue = SplineSeriesDataLabelsOverflow.Justify;
            ...
            this.VerticalAlign = this.VerticalAlign_DefaultValue = SplineSeriesDataLabelsVerticalAlign.Null;
            nullable2 = new double?(0.0);
        ...
        internal override Hashtable ToHashtable()
        {
            ...
            if (this.Formatter != this.Formatter_DefaultValue)
            {
                ...
                Highstock.AddFunction("SplineSeriesDataLabelsFormatter.formatter", this.Formatter);
            }
