...
// Type: Highsoft.Web.Mvc.Stocks.PlotOptionsColumnrangeMarkerStatesHover
...
{
  public class PlotOptionsColumnrangeMarkerStatesHover : BaseObject
  {
    ...
    internal override Hashtable ToHashtable()
    {
      ...
      if ((lineWidth.GetValueOrDefault() == nullable1.GetValueOrDefault() ? (lineWidth.HasValue != nullable1.HasValue ? 1 : 0) : 1) != 0)
