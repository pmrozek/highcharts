// Type: Highsoft.Web.Mvc.Stocks.PlotOptionsCandlestickMarker
...
{
    public class PlotOptionsCandlestickMarker : BaseObject
    {
        ...
        public PlotOptionsCandlestickMarker()
        {
            ...
            this.States = this.States_DefaultValue = new PlotOptionsCandlestickMarkerStates();
        ...
        internal override Hashtable ToHashtable()
        {
            ...
            if ((height.GetValueOrDefault() == nullable1.GetValueOrDefault()
                    ? (height.HasValue != nullable1.HasValue ? 1 : 0)
                    : 1) != 0)
