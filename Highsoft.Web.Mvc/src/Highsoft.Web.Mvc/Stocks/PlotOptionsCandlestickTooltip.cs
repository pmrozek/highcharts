// Type: Highsoft.Web.Mvc.Stocks.PlotOptionsCandlestickTooltip
...
{
    public class PlotOptionsCandlestickTooltip : BaseObject
    {
        ...
        internal override Hashtable ToHashtable()
        {
            ...
            if (this.PointFormatter != this.PointFormatter_DefaultValue)
            {
                ...
                Highstock.AddFunction("PlotOptionsCandlestickTooltipPointFormatter.pointFormatter", this.PointFormatter);
            }
