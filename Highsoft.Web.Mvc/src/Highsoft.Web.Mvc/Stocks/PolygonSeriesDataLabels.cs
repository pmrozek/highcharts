// Type: Highsoft.Web.Mvc.Stocks.PolygonSeriesDataLabels
...
namespace Highsoft.Web.Mvc.Stocks
{
    public class PolygonSeriesDataLabels : BaseObject
    {
        ...
        {
            this.Align = this.Align_DefaultValue = PolygonSeriesDataLabelsAlign.Center;
            ...
            this.Overflow = this.Overflow_DefaultValue = PolygonSeriesDataLabelsOverflow.Justify;
            ...
            this.VerticalAlign = this.VerticalAlign_DefaultValue = PolygonSeriesDataLabelsVerticalAlign.Null;
            nullable2 = new double?(0.0);
        ...
        internal override Hashtable ToHashtable()
        {
            ...
            if (this.Formatter != this.Formatter_DefaultValue)
            {
                ...
                Highstock.AddFunction("PolygonSeriesDataLabelsFormatter.formatter", this.Formatter);
            }
