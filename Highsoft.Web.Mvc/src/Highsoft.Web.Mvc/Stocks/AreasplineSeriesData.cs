// Type: Highsoft.Web.Mvc.Stocks.AreasplineSeriesData
...
namespace Highsoft.Web.Mvc.Stocks
{
    public class AreasplineSeriesData : BaseObject
    {
        ...
        public AreasplineSeriesData()
        {
            ...
            this.Events = this.Events_DefaultValue = new AreasplineSeriesDataEvents();
            this.Id = this.Id_DefaultValue = "null";
            double? nullable1 = new double?();
            this.Labelrank_DefaultValue = nullable1;
            this.Labelrank = nullable1;
            this.Marker = this.Marker_DefaultValue = new AreasplineSeriesDataMarker();
