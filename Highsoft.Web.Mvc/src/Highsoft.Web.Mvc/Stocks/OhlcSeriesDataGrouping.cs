// Type: Highsoft.Web.Mvc.Stocks.OhlcSeriesDataGrouping
...
{
    public class OhlcSeriesDataGrouping : BaseObject
    {
        ...
        internal override Hashtable ToHashtable()
        {
            ...
            if (this.Approximation != this.Approximation_DefaultValue)
            {
                ...
                Highstock.AddFunction("OhlcSeriesDataGroupingApproximation.approximation", this.Approximation);
            }
