...
// Type: Highsoft.Web.Mvc.Stocks.PlotOptionsAreasplinerangeEvents
  ...
  public class PlotOptionsAreasplinerangeEvents : BaseObject
  {
    ...
    internal override Hashtable ToHashtable()
    {
      ...
      if (this.CheckboxClick != this.CheckboxClick_DefaultValue)
      {
        ...
        Highstock.AddFunction("PlotOptionsAreasplinerangeEventsCheckboxClick.checkboxClick", this.CheckboxClick);
      }
      ...
      if (this.LegendItemClick != this.LegendItemClick_DefaultValue)
      {
        ...
        Highstock.AddFunction("PlotOptionsAreasplinerangeEventsLegendItemClick.legendItemClick", this.LegendItemClick);
      }
