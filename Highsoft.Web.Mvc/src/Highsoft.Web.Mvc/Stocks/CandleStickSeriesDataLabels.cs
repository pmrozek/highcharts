// Type: Highsoft.Web.Mvc.Stocks.CandleStickSeriesDataLabels
...
{
    public class CandleStickSeriesDataLabels : BaseObject
    {
        ...
        {
            this.Align = this.Align_DefaultValue = CandleStickSeriesDataLabelsAlign.Center;
            ...
            this.Overflow = this.Overflow_DefaultValue = CandleStickSeriesDataLabelsOverflow.Justify;
            ...
            this.VerticalAlign = this.VerticalAlign_DefaultValue = CandleStickSeriesDataLabelsVerticalAlign.Null;
            nullable2 = new double?(0.0);
        ...
        internal override Hashtable ToHashtable()
        {
            ...
            if (this.Formatter != this.Formatter_DefaultValue)
            {
                ...
                Highstock.AddFunction("CandleStickSeriesDataLabelsFormatter.formatter", this.Formatter);
            }
