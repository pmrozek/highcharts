// Type: Highsoft.Web.Mvc.Stocks.PlotOptionsScatterDataLabels
...
namespace Highsoft.Web.Mvc.Stocks
{
    public class PlotOptionsScatterDataLabels : BaseObject
    {
        ...
        {
            this.Align = this.Align_DefaultValue = PlotOptionsScatterDataLabelsAlign.Center;
            ...
            this.Overflow = this.Overflow_DefaultValue = PlotOptionsScatterDataLabelsOverflow.Justify;
            ...
            this.VerticalAlign = this.VerticalAlign_DefaultValue = PlotOptionsScatterDataLabelsVerticalAlign.Null;
            nullable2 = new double?(0.0);
        ...
        internal override Hashtable ToHashtable()
        {
            ...
            if (this.Formatter != this.Formatter_DefaultValue)
            {
                ...
                Highstock.AddFunction("PlotOptionsScatterDataLabelsFormatter.formatter", this.Formatter);
            }
