// Type: Highsoft.Web.Mvc.Stocks.PlotOptionsOhlcDataLabels
...
{
    public class PlotOptionsOhlcDataLabels : BaseObject
    {
        public PlotOptionsOhlcDataLabels()
        {
            this.Align = this.Align_DefaultValue = PlotOptionsOhlcDataLabelsAlign.Center;
            ...
            this.Overflow = this.Overflow_DefaultValue = PlotOptionsOhlcDataLabelsOverflow.Justify;
            ...
            this.VerticalAlign = this.VerticalAlign_DefaultValue = PlotOptionsOhlcDataLabelsVerticalAlign.Null;
            nullable2 = new double?(0.0);
