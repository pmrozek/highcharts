...
// Type: Highsoft.Web.Mvc.Stocks.PolygonSeriesStatesHover
...
namespace Highsoft.Web.Mvc.Stocks
{
  public class PolygonSeriesStatesHover : BaseObject
  {
    ...
    public PolygonSeriesStatesHover()
    {
      ...
      this.Halo = this.Halo_DefaultValue = new PolygonSeriesStatesHoverHalo();
      ...
      this.Marker = this.Marker_DefaultValue = new PolygonSeriesStatesHoverMarker();
    }
