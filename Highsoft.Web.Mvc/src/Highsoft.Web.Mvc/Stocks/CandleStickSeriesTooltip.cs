// Type: Highsoft.Web.Mvc.Stocks.CandleStickSeriesTooltip
...
{
    public class CandleStickSeriesTooltip : BaseObject
    {
        ...
        internal override Hashtable ToHashtable()
        {
            ...
            if (this.PointFormatter != this.PointFormatter_DefaultValue)
            {
                ...
                Highstock.AddFunction("CandleStickSeriesTooltipPointFormatter.pointFormatter", this.PointFormatter);
            }
