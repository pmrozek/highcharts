// Type: Highsoft.Web.Mvc.Stocks.AreaSeriesData
...
namespace Highsoft.Web.Mvc.Stocks
{
    public class AreaSeriesData : BaseObject
    {
        public AreaSeriesData()
        {
            ...
            this.Events = this.Events_DefaultValue = new AreaSeriesDataEvents();
            this.Id = this.Id_DefaultValue = "null";
            double? nullable1 = new double?();
            this.Labelrank_DefaultValue = nullable1;
            this.Labelrank = nullable1;
            this.Marker = this.Marker_DefaultValue = new AreaSeriesDataMarker();
